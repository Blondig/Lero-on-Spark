 ...
 */
  class TaskSet {
  // not preceding
  public   TaskSet (org.apache.spark.scheduler.Task<?>[] tasks, int stageId, int stageAttemptId, int priority, java.util.Properties properties, int resourceProfileId)  { throw new RuntimeException(); }
