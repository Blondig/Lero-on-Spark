...
public  class JavaPairRDD<K extends java.lang.Object, V extends java.lang.Object> extends org.apache.spark.api.java.AbstractJavaRDDLike<scala.Tuple2<K, V>, org.apache.spark.api.java.JavaPairRDD<K, V>> {
  ...
  /**
   * Return a RDD containing only the elements in the inclusive range <code>lower</code> to <code>upper</code>.
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.api.java.JavaPairRDD<K, V> filterByRange (K lower, K upper)  { throw new RuntimeException(); }
  /**
   * Return a RDD containing only the elements in the inclusive range <code>lower</code> to <code>upper</code>.
   * If the RDD has been partitioned using a <code>RangePartitioner</code>, then this operation can be
   * performed efficiently by only scanning the partitions that might contain matching elements.
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.api.java.JavaPairRDD<K, V> filterByRange (java.util.Comparator<K> comp, K lower, K upper)  { throw new RuntimeException(); }
  /**
