...
public  class Utils {
   ...
   * @return (undocumented)
   */
  static public  java.io.File fetchFile (java.lang.String url, java.io.File targetDir, org.apache.spark.SparkConf conf, org.apache.hadoop.conf.Configuration hadoopConf, long timestamp, boolean useCache, boolean shouldUntar)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  java.io.File doFetchFile (java.lang.String url, java.io.File targetDir, java.lang.String filename, org.apache.spark.SparkConf conf, org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
  /**
  ...
  static public  boolean isAbsoluteURI (java.lang.String path)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  static public  java.lang.String buildLocationMetadata (scala.collection.Seq<org.apache.hadoop.fs.Path> paths, int stopAppendingThreshold)  { throw new RuntimeException(); }
  /**
   * Convert MEMORY_OFFHEAP_SIZE to MB Unit, return 0 if MEMORY_OFFHEAP_ENABLED is false.
   * @param sparkConf (undocumented)
   * @return (undocumented)
   */
  static public  int executorOffHeapMemorySizeAsMb (org.apache.spark.SparkConf sparkConf)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  long checkOffHeapEnabled (org.apache.spark.SparkConf sparkConf, long offHeapSize)  { throw new RuntimeException(); }
  /** Returns a string message about delegation token generation failure */
  static public  java.lang.String createFailedToGetTokenMessage (java.lang.String serviceName, java.lang.Throwable e)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  scala.collection.Seq<java.io.File> unzipFilesFromFile (org.apache.hadoop.fs.FileSystem fs, org.apache.hadoop.fs.Path dfsZipFile, java.io.File localDir)  { throw new RuntimeException(); }
  /**
