...
public  interface WritablePartitionedPairCollection<K extends java.lang.Object, V extends java.lang.Object> {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.util.collection.WritablePartitionedIterator<K, V> destructiveSortedWritablePartitionedIterator (scala.Option<java.util.Comparator<K>> keyComparator)  ;
}
