...
public  class JsonProtocol {
  ...
  static public  org.json4s.JsonAST.JValue resourceProfileAddedToJson (org.apache.spark.scheduler.SparkListenerResourceProfileAdded profileAdded)  { throw new RuntimeException(); }
  ...
  static public  org.json4s.JsonAST.JValue executorResourceRequestToJson (org.apache.spark.resource.ExecutorResourceRequest execReq)  { throw new RuntimeException(); }
  static public  org.json4s.JsonAST.JValue executorResourceRequestMapToJson (scala.collection.Map<java.lang.String, org.apache.spark.resource.ExecutorResourceRequest> m)  { throw new RuntimeException(); }
  static public  org.json4s.JsonAST.JValue taskResourceRequestToJson (org.apache.spark.resource.TaskResourceRequest taskReq)  { throw new RuntimeException(); }
  static public  org.json4s.JsonAST.JValue taskResourceRequestMapToJson (scala.collection.Map<java.lang.String, org.apache.spark.resource.TaskResourceRequest> m)  { throw new RuntimeException(); }
  /** ------------------------------ *
  ...
  static public  org.apache.spark.scheduler.SparkListenerResourceProfileAdded resourceProfileAddedFromJson (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  static public  org.apache.spark.resource.ExecutorResourceRequest executorResourceRequestFromJson (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  static public  org.apache.spark.resource.TaskResourceRequest taskResourceRequestFromJson (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  static public  scala.collection.Map<java.lang.String, org.apache.spark.resource.TaskResourceRequest> taskResourceRequestMapFromJson (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  static public  scala.collection.Map<java.lang.String, org.apache.spark.resource.ExecutorResourceRequest> executorResourceRequestMapFromJson (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
