 ...
 */
 abstract class Shim {
  ...
  public abstract  void alterDatabase (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, org.apache.hadoop.hive.metastore.api.Database d)  ;
  ...
  public abstract  void createDatabase (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.metastore.api.Database db, boolean ignoreIfExists)  ;
  ...
  public abstract  void createPartitions (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName, scala.collection.Seq<org.apache.spark.sql.catalyst.catalog.CatalogTablePartition> parts, boolean ignoreIfExists)  ;
  public abstract  void createTable (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.ql.metadata.Table table, boolean ifNotExists)  ;
  public abstract  boolean databaseExists (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName)  ;
  public abstract  void dropDatabase (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, boolean deleteData, boolean ignoreUnknownDb, boolean cascade)  ;
  ...
  public abstract  void dropTable (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName)  ;
  ...
  public abstract  scala.collection.Seq<java.lang.String> getAllDatabases (org.apache.hadoop.hive.ql.metadata.Hive hive)  ;
  ...
  public abstract  scala.collection.Seq<java.lang.String> getAllTables (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName)  ;
  ...
  public abstract  org.apache.hadoop.hive.metastore.api.Database getDatabase (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName)  ;
  public abstract  java.lang.String getDatabaseOwnerName (org.apache.hadoop.hive.metastore.api.Database db)  ;
  public abstract  scala.collection.Seq<java.lang.String> getDatabasesByPattern (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String pattern)  ;
  ...
  public abstract  scala.collection.Seq<org.apache.hadoop.hive.metastore.api.Index> getIndexes (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName, short max)  ;
  ...
  public abstract  org.apache.hadoop.hive.ql.metadata.Partition getPartition (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.ql.metadata.Table table, java.util.Map<java.lang.String, java.lang.String> partSpec, boolean forceCreate)  ;
  public abstract  scala.collection.Seq<java.lang.String> getPartitionNames (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName, short max)  ;
  public abstract  scala.collection.Seq<java.lang.String> getPartitionNames (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName, java.util.Map<java.lang.String, java.lang.String> partSpec, short max)  ;
  public abstract  scala.collection.Seq<org.apache.hadoop.hive.ql.metadata.Partition> getPartitions (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.ql.metadata.Table table, java.util.Map<java.lang.String, java.lang.String> partSpec)  ;
  public abstract  scala.collection.Seq<org.apache.hadoop.hive.ql.metadata.Partition> getPartitionsByFilter (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.ql.metadata.Table table, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> predicates, org.apache.spark.sql.catalyst.catalog.CatalogTable catalogTable)  ;
  public abstract  org.apache.hadoop.hive.ql.metadata.Table getTable (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName, boolean throwException)  ;
  public abstract  scala.collection.Seq<java.lang.String> getTablesByPattern (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String pattern)  ;
  ...
  public  void recordHiveCall ()  { throw new RuntimeException(); }
  ...
  public abstract  void renamePartition (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.ql.metadata.Table table, java.util.Map<java.lang.String, java.lang.String> oldPartSpec, org.apache.hadoop.hive.ql.metadata.Partition newPart)  ;
  /**
