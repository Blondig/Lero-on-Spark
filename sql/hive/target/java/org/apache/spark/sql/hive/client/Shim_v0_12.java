package org.apache.spark.sql.hive.client;
  ...
  public  void alterDatabase (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, org.apache.hadoop.hive.metastore.api.Database d)  { throw new RuntimeException(); }
  ...
  public  void createDatabase (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.metastore.api.Database db, boolean ignoreIfExists)  { throw new RuntimeException(); }
  ...
  public  void createTable (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.ql.metadata.Table table, boolean ifNotExists)  { throw new RuntimeException(); }
  public  boolean databaseExists (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName)  { throw new RuntimeException(); }
  // not preceding
  protected  java.lang.Boolean deleteDataInDropIndex ()  { throw new RuntimeException(); }
  public  void dropDatabase (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, boolean deleteData, boolean ignoreUnknownDb, boolean cascade)  { throw new RuntimeException(); }
  ...
  public  void dropTable (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName)  { throw new RuntimeException(); }
  public  scala.collection.Seq<java.lang.String> getAllDatabases (org.apache.hadoop.hive.ql.metadata.Hive hive)  { throw new RuntimeException(); }
  ...
  public  scala.collection.Seq<java.lang.String> getAllTables (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName)  { throw new RuntimeException(); }
  ...
  public  org.apache.hadoop.hive.metastore.api.Database getDatabase (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName)  { throw new RuntimeException(); }
  public  java.lang.String getDatabaseOwnerName (org.apache.hadoop.hive.metastore.api.Database db)  { throw new RuntimeException(); }
  public  scala.collection.Seq<java.lang.String> getDatabasesByPattern (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String pattern)  { throw new RuntimeException(); }
  ...
  public  scala.collection.Seq<org.apache.hadoop.hive.metastore.api.Index> getIndexes (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName, short max)  { throw new RuntimeException(); }
  ...
  public  org.apache.hadoop.hive.ql.metadata.Partition getPartition (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.ql.metadata.Table table, java.util.Map<java.lang.String, java.lang.String> partSpec, boolean forceCreate)  { throw new RuntimeException(); }
  public  scala.collection.Seq<java.lang.String> getPartitionNames (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName, short max)  { throw new RuntimeException(); }
  public  scala.collection.Seq<java.lang.String> getPartitionNames (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName, java.util.Map<java.lang.String, java.lang.String> partSpec, short max)  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.hadoop.hive.ql.metadata.Partition> getPartitions (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.ql.metadata.Table table, java.util.Map<java.lang.String, java.lang.String> partSpec)  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.hadoop.hive.ql.metadata.Partition> getPartitionsByFilter (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.ql.metadata.Table table, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> predicates, org.apache.spark.sql.catalyst.catalog.CatalogTable catalogTable)  { throw new RuntimeException(); }
  public  org.apache.hadoop.hive.ql.metadata.Table getTable (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String tableName, boolean throwException)  { throw new RuntimeException(); }
  public  scala.collection.Seq<java.lang.String> getTablesByPattern (org.apache.hadoop.hive.ql.metadata.Hive hive, java.lang.String dbName, java.lang.String pattern)  { throw new RuntimeException(); }
  ...
  public  void renamePartition (org.apache.hadoop.hive.ql.metadata.Hive hive, org.apache.hadoop.hive.ql.metadata.Table table, java.util.Map<java.lang.String, java.lang.String> oldPartSpec, org.apache.hadoop.hive.ql.metadata.Partition newPart)  { throw new RuntimeException(); }
