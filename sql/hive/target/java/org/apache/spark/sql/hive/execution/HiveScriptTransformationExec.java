 ...
 */
  ...
  // not preceding
  public   HiveScriptTransformationExec (java.lang.String script, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.sql.execution.SparkPlan child, org.apache.spark.sql.execution.ScriptTransformationIOSchema ioschema)  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.hive.execution.HiveScriptTransformationExec withNewChildInternal (org.apache.spark.sql.execution.SparkPlan newChild)  { throw new RuntimeException(); }
}
