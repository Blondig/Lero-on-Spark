...
public abstract class StreamExecution implements org.apache.spark.sql.streaming.StreamingQuery, org.apache.spark.sql.execution.streaming.ProgressReporter, org.apache.spark.internal.Logging {
  ...
  static public  scala.collection.Seq<java.lang.String> IO_EXCEPTION_NAMES ()  { throw new RuntimeException(); }
  static public  scala.util.matching.Regex PROXY_ERROR ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan analyzedPlan ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   StreamExecution (org.apache.spark.sql.SparkSession sparkSession, java.lang.String name, java.lang.String resolvedCheckpointRoot, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan analyzedPlan, org.apache.spark.sql.connector.catalog.Table sink, org.apache.spark.sql.streaming.Trigger trigger, org.apache.spark.util.Clock triggerClock, org.apache.spark.sql.streaming.OutputMode outputMode, boolean deleteCheckpointOnStop)  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.connector.write.Write createWrite (org.apache.spark.sql.connector.catalog.SupportsWrite table, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan inputPlan)  { throw new RuntimeException(); }
