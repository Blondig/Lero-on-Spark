...
public  class ExecutionListenerManager implements org.apache.spark.internal.Logging {
     ExecutionListenerManager (org.apache.spark.sql.SparkSession session, org.apache.spark.sql.internal.SQLConf sqlConf, boolean loadExtensions)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
    org.apache.spark.sql.util.ExecutionListenerManager clone (org.apache.spark.sql.SparkSession session, org.apache.spark.sql.internal.SQLConf sqlConf)  { throw new RuntimeException(); }
