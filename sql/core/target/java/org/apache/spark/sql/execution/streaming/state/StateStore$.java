...
public  class StateStore$ implements org.apache.spark.internal.Logging {
  ...
  public  org.apache.spark.sql.execution.streaming.state.ReadStateStore getReadOnly (org.apache.spark.sql.execution.streaming.state.StateStoreProviderId storeProviderId, org.apache.spark.sql.types.StructType keySchema, org.apache.spark.sql.types.StructType valueSchema, int numColsPrefixKey, long version, org.apache.spark.sql.execution.streaming.state.StateStoreConf storeConf, org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
  /** Get or create a store associated with the id. */
  public  org.apache.spark.sql.execution.streaming.state.StateStore get (org.apache.spark.sql.execution.streaming.state.StateStoreProviderId storeProviderId, org.apache.spark.sql.types.StructType keySchema, org.apache.spark.sql.types.StructType valueSchema, int numColsPrefixKey, long version, org.apache.spark.sql.execution.streaming.state.StateStoreConf storeConf, org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
