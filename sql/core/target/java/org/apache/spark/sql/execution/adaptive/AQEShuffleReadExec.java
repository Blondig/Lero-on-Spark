 ...
 *                        partition.
 */
public  class AQEShuffleReadExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, scala.Product, scala.Serializable {
  ...
  public  boolean isLocalRead ()  { throw new RuntimeException(); }
  public  boolean isCoalescedRead ()  { throw new RuntimeException(); }
  // not preceding
  ...
  protected  org.apache.spark.sql.execution.adaptive.AQEShuffleReadExec withNewChildInternal (org.apache.spark.sql.execution.SparkPlan newChild)  { throw new RuntimeException(); }
}
