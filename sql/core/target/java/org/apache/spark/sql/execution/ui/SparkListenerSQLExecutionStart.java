...
public  class SparkListenerSQLExecutionStart implements org.apache.spark.scheduler.SparkListenerEvent, scala.Product, scala.Serializable {
  ...
  public  scala.collection.immutable.Map<java.lang.String, java.lang.String> modifiedConfigs ()  { throw new RuntimeException(); }
  // not preceding
  public   SparkListenerSQLExecutionStart (long executionId, java.lang.String description, java.lang.String details, java.lang.String physicalPlanDescription, org.apache.spark.sql.execution.SparkPlanInfo sparkPlanInfo, long time, scala.collection.immutable.Map<java.lang.String, java.lang.String> modifiedConfigs)  { throw new RuntimeException(); }
}
