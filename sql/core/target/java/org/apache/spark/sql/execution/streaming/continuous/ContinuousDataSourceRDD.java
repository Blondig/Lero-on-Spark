...
public  class ContinuousDataSourceRDD extends org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> {
  // not preceding
  public   ContinuousDataSourceRDD (org.apache.spark.SparkContext sc, int dataQueueSize, long epochPollIntervalMs, scala.collection.Seq<org.apache.spark.sql.connector.read.InputPartition> inputPartitions, org.apache.spark.sql.types.StructType schema, org.apache.spark.sql.connector.read.streaming.ContinuousPartitionReaderFactory partitionReaderFactory, scala.collection.immutable.Map<java.lang.String, org.apache.spark.sql.execution.metric.SQLMetric> customMetrics)  { throw new RuntimeException(); }
  /**
