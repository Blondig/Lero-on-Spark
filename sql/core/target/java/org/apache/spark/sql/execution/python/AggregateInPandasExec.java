...
public  class AggregateInPandasExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, scala.Product, scala.Serializable {
  ...
  public  scala.Option<org.apache.spark.sql.catalyst.expressions.NamedExpression> sessionWindowOption ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.NamedExpression> groupingWithoutSessionExpressions ()  { throw new RuntimeException(); }
