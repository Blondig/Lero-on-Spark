...
public  class StreamingDeduplicateExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, org.apache.spark.sql.execution.streaming.StateStoreWriter, org.apache.spark.sql.execution.streaming.WatermarkSupport, scala.Product, scala.Serializable {
  ...
  public  scala.collection.Seq<org.apache.spark.sql.execution.streaming.StatefulOperatorCustomMetric> customStatefulOperatorMetrics ()  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.execution.streaming.StreamingDeduplicateExec withNewChildInternal (org.apache.spark.sql.execution.SparkPlan newChild)  { throw new RuntimeException(); }
}
