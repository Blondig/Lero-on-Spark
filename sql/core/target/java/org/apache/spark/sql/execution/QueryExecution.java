...
public  class QueryExecution implements org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.execution.SparkPlan prepareExecutedPlan (org.apache.spark.sql.SparkSession session, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan, org.apache.spark.sql.execution.adaptive.AdaptiveExecutionContext context)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static   java.lang.Throwable toInternalError (java.lang.String msg, java.lang.Throwable e)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static  <T extends java.lang.Object> T withInternalError (java.lang.String msg, scala.Function0<T> block)  { throw new RuntimeException(); }
  /**
  ...
  // not preceding
  public   QueryExecution (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan logical, org.apache.spark.sql.catalyst.QueryPlanningTracker tracker, scala.Enumeration.Value mode)  { throw new RuntimeException(); }
  ...
  // not preceding
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan commandExecuted ()  { throw new RuntimeException(); }
  // not preceding
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan withCachedData ()  { throw new RuntimeException(); }
  public  void assertCommandExecuted ()  { throw new RuntimeException(); }
  // not preceding
