...
public  class SparkSession implements scala.Serializable, java.io.Closeable, org.apache.spark.internal.Logging {
  ...
  /**
   * Apply modifiable settings to an existing {@link SparkSession}. This method are used
   * both in Scala and Python, so put this under {@link SparkSession} object.
   * @param session (undocumented)
   * @param options (undocumented)
   */
  static   void applyModifiableSettings (org.apache.spark.sql.SparkSession session, java.util.HashMap<java.lang.String, java.lang.String> options)  { throw new RuntimeException(); }
  /**
   ...
   * @param initialSessionOptions (undocumented)
   */
     SparkSession (org.apache.spark.SparkContext sc, java.util.HashMap<java.lang.String, java.lang.String> initialSessionOptions)  { throw new RuntimeException(); }
