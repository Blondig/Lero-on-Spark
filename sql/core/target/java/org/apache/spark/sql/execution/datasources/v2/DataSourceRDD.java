...
public  class DataSourceRDD extends org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> {
  // not preceding
  public   DataSourceRDD (org.apache.spark.SparkContext sc, scala.collection.Seq<scala.collection.Seq<org.apache.spark.sql.connector.read.InputPartition>> inputPartitions, org.apache.spark.sql.connector.read.PartitionReaderFactory partitionReaderFactory, boolean columnarReads, scala.collection.immutable.Map<java.lang.String, org.apache.spark.sql.execution.metric.SQLMetric> customMetrics)  { throw new RuntimeException(); }
