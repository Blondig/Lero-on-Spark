 ...
 */
public  class AtomicCreateTableAsSelectExec extends org.apache.spark.sql.execution.datasources.v2.V2CommandExec implements org.apache.spark.sql.execution.datasources.v2.TableWriteExecHelper, scala.Product, scala.Serializable {
  ...
  protected  scala.collection.immutable.Map<java.lang.String, org.apache.spark.sql.execution.metric.SQLMetric> customMetrics ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   AtomicCreateTableAsSelectExec (org.apache.spark.sql.connector.catalog.StagingTableCatalog catalog, org.apache.spark.sql.connector.catalog.Identifier ident, scala.collection.Seq<org.apache.spark.sql.connector.expressions.Transform> partitioning, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan, org.apache.spark.sql.execution.SparkPlan query, org.apache.spark.sql.catalyst.plans.logical.TableSpec tableSpec, org.apache.spark.sql.util.CaseInsensitiveStringMap writeOptions, boolean ifNotExists)  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.execution.datasources.v2.AtomicCreateTableAsSelectExec withNewChildInternal (org.apache.spark.sql.execution.SparkPlan newChild)  { throw new RuntimeException(); }
}
