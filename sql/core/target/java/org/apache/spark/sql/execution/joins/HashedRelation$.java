...
public  class HashedRelation$ {
   ...
   *                             <code>ShuffledHashJoinExec</code> only.
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.execution.joins.HashedRelation apply (scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> input, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> key, int sizeEstimate, org.apache.spark.memory.TaskMemoryManager taskMemoryManager, boolean isNullAware, boolean allowsNullKey, boolean ignoresDuplicatedKey)  { throw new RuntimeException(); }
}
