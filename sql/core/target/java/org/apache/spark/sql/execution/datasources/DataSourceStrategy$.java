...
public  class DataSourceStrategy$ extends org.apache.spark.sql.execution.SparkStrategy implements org.apache.spark.internal.Logging, org.apache.spark.sql.catalyst.analysis.CastSupport, org.apache.spark.sql.catalyst.expressions.PredicateHelper, org.apache.spark.sql.catalyst.SQLConfHelper {
   ...
   * @return (undocumented)
   */
  protected  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> normalizeExprs (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> exprs, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> attributes)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  protected  scala.Option<org.apache.spark.sql.sources.Filter> translateRuntimeFilter (org.apache.spark.sql.catalyst.expressions.Expression expr)  { throw new RuntimeException(); }
  /**
  ...
  protected  scala.Option<org.apache.spark.sql.connector.expressions.aggregate.AggregateFunc> translateAggregate (org.apache.spark.sql.catalyst.expressions.aggregate.AggregateExpression agg)  { throw new RuntimeException(); }
  /**
   ...
   */
  protected  scala.Option<org.apache.spark.sql.connector.expressions.aggregate.Aggregation> translateAggregation (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.aggregate.AggregateExpression> aggregates, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> groupBy)  { throw new RuntimeException(); }
  protected  scala.collection.Seq<org.apache.spark.sql.connector.expressions.SortOrder> translateSortOrders (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.SortOrder> sortOrders)  { throw new RuntimeException(); }
  /**
