...
public  class PythonSQLUtils {
  ...
  static public  boolean isTimestampNTZPreferred ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.api.java.JavaRDD<byte[]> readArrowStreamFromFile (org.apache.spark.sql.SparkSession session, java.lang.String filename)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> toDataFrame (org.apache.spark.api.java.JavaRDD<byte[]> arrowBatchRDD, java.lang.String schemaString, org.apache.spark.sql.SparkSession session)  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.Column castTimestampNTZToLong (org.apache.spark.sql.Column c)  { throw new RuntimeException(); }
