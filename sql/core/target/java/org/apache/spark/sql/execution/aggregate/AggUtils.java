...
public  class AggUtils {
   ...
   * @return (undocumented)
   */
  static public  scala.collection.Seq<org.apache.spark.sql.execution.SparkPlan> planStreamingAggregationForSession (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.NamedExpression> groupingExpressions, org.apache.spark.sql.catalyst.expressions.NamedExpression sessionExpression, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.aggregate.AggregateExpression> functionsWithoutDistinct, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.NamedExpression> resultExpressions, int stateFormatVersion, boolean mergeSessionsInLocalPartition, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
}
