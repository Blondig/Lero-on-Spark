...
public  class SparkSqlAstBuilder extends org.apache.spark.sql.catalyst.parser.AstBuilder {
  ...
  /**
   * Create a {@link CreateFunctionCommand}.
   * <p>
   * For example:
   * <pre><code>
  ...
  /**
   * Create or replace a view. This creates a {@link CreateViewCommand}.
   * <p>
   * For example:
   * <pre><code>
  ...
  /**
   * Create a {@link AddFilesCommand}, {@link AddJarsCommand}, {@link AddArchivesCommand},
  ...
  /**
   * Create a {@link SetCatalogCommand} logical command.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan visitSetCatalog (org.apache.spark.sql.catalyst.parser.SqlBaseParser.SetCatalogContext ctx)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Create a {@link ShowCatalogsCommand} logical command.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan visitShowCatalogs (org.apache.spark.sql.catalyst.parser.SqlBaseParser.ShowCatalogsContext ctx)  { throw new RuntimeException(); }
  /**
   * Create a {@link ShowCurrentNamespaceCommand} logical command.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  ...
  /**
   * Create a {@link SetNamespaceCommand} logical command.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan visitUseNamespace (org.apache.spark.sql.catalyst.parser.SqlBaseParser.UseNamespaceContext ctx)  { throw new RuntimeException(); }
  /**
