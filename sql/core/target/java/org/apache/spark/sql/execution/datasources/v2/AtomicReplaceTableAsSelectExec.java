...
public  class AtomicReplaceTableAsSelectExec extends org.apache.spark.sql.execution.datasources.v2.V2CommandExec implements org.apache.spark.sql.execution.datasources.v2.TableWriteExecHelper, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   AtomicReplaceTableAsSelectExec (org.apache.spark.sql.connector.catalog.StagingTableCatalog catalog, org.apache.spark.sql.connector.catalog.Identifier ident, scala.collection.Seq<org.apache.spark.sql.connector.expressions.Transform> partitioning, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan, org.apache.spark.sql.execution.SparkPlan query, org.apache.spark.sql.catalyst.plans.logical.TableSpec tableSpec, org.apache.spark.sql.util.CaseInsensitiveStringMap writeOptions, boolean orCreate, scala.Function3<org.apache.spark.sql.connector.catalog.TableCatalog, org.apache.spark.sql.connector.catalog.Table, org.apache.spark.sql.connector.catalog.Identifier, scala.runtime.BoxedUnit> invalidateCache)  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.execution.datasources.v2.AtomicReplaceTableAsSelectExec withNewChildInternal (org.apache.spark.sql.execution.SparkPlan newChild)  { throw new RuntimeException(); }
}
