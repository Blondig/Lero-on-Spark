...
public  class ContinuousWriteRDD extends org.apache.spark.rdd.RDD<scala.runtime.BoxedUnit> {
  // not preceding
  public   ContinuousWriteRDD (org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> prev, org.apache.spark.sql.connector.write.streaming.StreamingDataWriterFactory writerFactory, scala.collection.immutable.Map<java.lang.String, org.apache.spark.sql.execution.metric.SQLMetric> customMetrics)  { throw new RuntimeException(); }
