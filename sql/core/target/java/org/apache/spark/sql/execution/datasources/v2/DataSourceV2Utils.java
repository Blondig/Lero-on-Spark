...
public  class DataSourceV2Utils {
  ...
  static public  scala.Option<org.apache.spark.sql.Dataset<org.apache.spark.sql.Row>> loadV2Source (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.connector.catalog.TableProvider provider, scala.Option<org.apache.spark.sql.types.StructType> userSpecifiedSchema, org.apache.spark.sql.catalyst.util.CaseInsensitiveMap<java.lang.String> extraOptions, java.lang.String source, scala.collection.Seq<java.lang.String> paths)  { throw new RuntimeException(); }
