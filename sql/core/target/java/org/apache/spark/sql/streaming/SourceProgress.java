...
public  class SourceProgress implements scala.Serializable {
  ...
  public  java.util.Map<java.lang.String, java.lang.String> metrics ()  { throw new RuntimeException(); }
  // not preceding
  protected   SourceProgress (java.lang.String description, java.lang.String startOffset, java.lang.String endOffset, java.lang.String latestOffset, long numInputRows, double inputRowsPerSecond, double processedRowsPerSecond, java.util.Map<java.lang.String, java.lang.String> metrics)  { throw new RuntimeException(); }
