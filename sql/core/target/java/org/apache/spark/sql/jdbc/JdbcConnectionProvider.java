...
public abstract class JdbcConnectionProvider {
   ...
   * needed this API is called synchronized by <code>SecurityConfigurationLock</code> to avoid race when
   * <code>modifiesSecurityContext</code> returns true for the given driver with the given options.
   * <p>
   * @param driver  Java driver which initiates the connection
   * @param options Driver options which initiates the connection
   ...
   * @since 3.1.3
   */
  public abstract  boolean modifiesSecurityContext (java.sql.Driver driver, scala.collection.immutable.Map<java.lang.String, java.lang.String> options)  ;
  /**
