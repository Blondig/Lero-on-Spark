...
public  class ExplainUtils$ implements org.apache.spark.sql.execution.adaptive.AdaptiveSparkPlanHelper {
   ...
   */
  public <T extends org.apache.spark.sql.catalyst.plans.QueryPlan<T>> void processPlan (T plan, scala.Function1<java.lang.String, scala.runtime.BoxedUnit> append)  { throw new RuntimeException(); }
  /**
