...
public  class KeyValueGroupedDataset<K extends java.lang.Object, V extends java.lang.Object> implements scala.Serializable {
   ...
   * @return (undocumented)
   */
  public <U extends java.lang.Object, R extends java.lang.Object> org.apache.spark.sql.Dataset<R> cogroup (org.apache.spark.sql.KeyValueGroupedDataset<K, U> other, scala.Function3<K, scala.collection.Iterator<V>, scala.collection.Iterator<U>, scala.collection.TraversableOnce<R>> f, org.apache.spark.sql.Encoder<R> evidence$15)  { throw new RuntimeException(); }
  /**
   * (Java-specific)
   * Applies the given function to each cogrouped data.  For each unique group, the function will
   * be passed the grouping key and 2 iterators containing all elements in the group from
   ...
   * @return (undocumented)
   */
  public <S extends java.lang.Object, U extends java.lang.Object> org.apache.spark.sql.Dataset<U> flatMapGroupsWithState (org.apache.spark.sql.streaming.OutputMode outputMode, org.apache.spark.sql.streaming.GroupStateTimeout timeoutConf, scala.Function3<K, scala.collection.Iterator<V>, org.apache.spark.sql.streaming.GroupState<S>, scala.collection.Iterator<U>> func, org.apache.spark.sql.Encoder<S> evidence$11, org.apache.spark.sql.Encoder<U> evidence$12)  { throw new RuntimeException(); }
  /**
   * (Scala-specific)
   * Applies the given function to each group of data, while maintaining a user-defined per-group
   * state. The result Dataset will represent the objects returned by the function.
   ...
   * @return (undocumented)
   */
  public <S extends java.lang.Object, U extends java.lang.Object> org.apache.spark.sql.Dataset<U> flatMapGroupsWithState (org.apache.spark.sql.streaming.OutputMode outputMode, org.apache.spark.sql.streaming.GroupStateTimeout timeoutConf, org.apache.spark.sql.KeyValueGroupedDataset<K, S> initialState, scala.Function3<K, scala.collection.Iterator<V>, org.apache.spark.sql.streaming.GroupState<S>, scala.collection.Iterator<U>> func, org.apache.spark.sql.Encoder<S> evidence$13, org.apache.spark.sql.Encoder<U> evidence$14)  { throw new RuntimeException(); }
  /**
   * (Java-specific)
   * Applies the given function to each group of data, while maintaining a user-defined per-group
   * state. The result Dataset will represent the objects returned by the function.
   ...
   * @return (undocumented)
   */
  public <S extends java.lang.Object, U extends java.lang.Object> org.apache.spark.sql.Dataset<U> flatMapGroupsWithState (org.apache.spark.api.java.function.FlatMapGroupsWithStateFunction<K, V, S, U> func, org.apache.spark.sql.streaming.OutputMode outputMode, org.apache.spark.sql.Encoder<S> stateEncoder, org.apache.spark.sql.Encoder<U> outputEncoder, org.apache.spark.sql.streaming.GroupStateTimeout timeoutConf, org.apache.spark.sql.KeyValueGroupedDataset<K, S> initialState)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <S extends java.lang.Object, U extends java.lang.Object> org.apache.spark.sql.Dataset<U> mapGroupsWithState (org.apache.spark.sql.streaming.GroupStateTimeout timeoutConf, org.apache.spark.sql.KeyValueGroupedDataset<K, S> initialState, scala.Function3<K, scala.collection.Iterator<V>, org.apache.spark.sql.streaming.GroupState<S>, U> func, org.apache.spark.sql.Encoder<S> evidence$9, org.apache.spark.sql.Encoder<U> evidence$10)  { throw new RuntimeException(); }
  /**
   * (Java-specific)
   * Applies the given function to each group of data, while maintaining a user-defined per-group
   * state. The result Dataset will represent the objects returned by the function.
   ...
   * @return (undocumented)
   */
  public <S extends java.lang.Object, U extends java.lang.Object> org.apache.spark.sql.Dataset<U> mapGroupsWithState (org.apache.spark.api.java.function.MapGroupsWithStateFunction<K, V, S, U> func, org.apache.spark.sql.Encoder<S> stateEncoder, org.apache.spark.sql.Encoder<U> outputEncoder, org.apache.spark.sql.streaming.GroupStateTimeout timeoutConf, org.apache.spark.sql.KeyValueGroupedDataset<K, S> initialState)  { throw new RuntimeException(); }
  /**
