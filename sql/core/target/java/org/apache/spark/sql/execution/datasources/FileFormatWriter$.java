...
public  class FileFormatWriter$ implements org.apache.spark.internal.Logging {
   ...
   */
    void processStats (scala.collection.Seq<org.apache.spark.sql.execution.datasources.WriteJobStatsTracker> statsTrackers, scala.collection.Seq<scala.collection.Seq<org.apache.spark.sql.execution.datasources.WriteTaskStats>> statsPerTask, long jobCommitDuration)  { throw new RuntimeException(); }
}
