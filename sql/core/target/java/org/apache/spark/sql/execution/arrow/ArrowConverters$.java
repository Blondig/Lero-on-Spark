...
public  class ArrowConverters$ {
   ...
   * @return (undocumented)
   */
    org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> toDataFrame (org.apache.spark.api.java.JavaRDD<byte[]> arrowBatchRDD, java.lang.String schemaString, org.apache.spark.sql.SparkSession session)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
    org.apache.spark.api.java.JavaRDD<byte[]> readArrowStreamFromFile (org.apache.spark.sql.SparkSession session, java.lang.String filename)  { throw new RuntimeException(); }
  /**
