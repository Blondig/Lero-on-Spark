...
public  class MicroBatchExecution extends org.apache.spark.sql.execution.streaming.StreamExecution {
  ...
  // not preceding
  public   MicroBatchExecution (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.streaming.Trigger trigger, org.apache.spark.util.Clock triggerClock, scala.collection.immutable.Map<java.lang.String, java.lang.String> extraOptions, org.apache.spark.sql.catalyst.streaming.WriteToStream plan)  { throw new RuntimeException(); }
