...
public  class MicroBatchScanExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.datasources.v2.DataSourceV2ScanExecBase, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   MicroBatchScanExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.sql.connector.read.Scan scan, org.apache.spark.sql.connector.read.streaming.MicroBatchStream stream, org.apache.spark.sql.connector.read.streaming.Offset start, org.apache.spark.sql.connector.read.streaming.Offset end, scala.Option<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>> keyGroupedPartitioning)  { throw new RuntimeException(); }
