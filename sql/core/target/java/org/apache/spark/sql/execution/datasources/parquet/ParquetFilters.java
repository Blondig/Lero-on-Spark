...
public  class ParquetFilters {
  public   ParquetFilters (org.apache.parquet.schema.MessageType schema, boolean pushDownDate, boolean pushDownTimestamp, boolean pushDownDecimal, boolean pushDownStartWith, int pushDownInFilterThreshold, boolean caseSensitive, org.apache.spark.sql.catalyst.util.RebaseDateTime.RebaseSpec datetimeRebaseSpec)  { throw new RuntimeException(); }
