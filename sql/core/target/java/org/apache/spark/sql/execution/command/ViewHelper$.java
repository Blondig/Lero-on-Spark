...
public  class ViewHelper$ implements org.apache.spark.sql.catalyst.SQLConfHelper, org.apache.spark.internal.Logging {
  /**
  ...
  public  void verifyAutoGeneratedAliasesNotExists (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan child, boolean isTemporary, org.apache.spark.sql.catalyst.TableIdentifier name)  { throw new RuntimeException(); }
  /**
   * Permanent views are not allowed to reference temp objects, including temp function and views
   * @param isTemporary (undocumented)
   * @param name (undocumented)
   * @param child (undocumented)
   * @param referredTempFunctions (undocumented)
   */
  public  void verifyTemporaryObjectsNotExists (boolean isTemporary, org.apache.spark.sql.catalyst.TableIdentifier name, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan child, scala.collection.Seq<java.lang.String> referredTempFunctions)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation createTemporaryViewRelation (org.apache.spark.sql.catalyst.TableIdentifier name, org.apache.spark.sql.SparkSession session, boolean replace, scala.Function1<java.lang.String, scala.Option<org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation>> getRawTempView, scala.Option<java.lang.String> originalText, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan analyzedPlan, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan aliasedPlan, scala.collection.Seq<java.lang.String> referredTempFunctions)  { throw new RuntimeException(); }
}
