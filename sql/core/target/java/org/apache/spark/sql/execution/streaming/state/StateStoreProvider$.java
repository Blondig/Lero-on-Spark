...
public  class StateStoreProvider$ {
   ...
   * @param numColsPrefixKey (undocumented)
   * @param storeConf (undocumented)
   * @param hadoopConf (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.execution.streaming.state.StateStoreProvider createAndInit (org.apache.spark.sql.execution.streaming.state.StateStoreProviderId providerId, org.apache.spark.sql.types.StructType keySchema, org.apache.spark.sql.types.StructType valueSchema, int numColsPrefixKey, org.apache.spark.sql.execution.streaming.state.StateStoreConf storeConf, org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
  /**
