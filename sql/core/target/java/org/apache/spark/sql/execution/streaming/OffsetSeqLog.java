...
public  class OffsetSeqLog extends org.apache.spark.sql.execution.streaming.HDFSMetadataLog<org.apache.spark.sql.execution.streaming.OffsetSeq> {
  ...
  public  boolean add (long batchId, org.apache.spark.sql.execution.streaming.OffsetSeq metadata)  { throw new RuntimeException(); }
  public  scala.Option<org.apache.spark.sql.execution.streaming.OffsetSeq> get (long batchId)  { throw new RuntimeException(); }
