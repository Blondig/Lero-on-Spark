 ...
 *        via <code>spark.sql.parquet.fieldId.write.enabled = false</code> to disable writing field ids.
 */
public  class SparkToParquetSchemaConverter {
  public   SparkToParquetSchemaConverter (boolean writeLegacyParquetFormat, scala.Enumeration.Value outputTimestampType, boolean useFieldId)  { throw new RuntimeException(); }
