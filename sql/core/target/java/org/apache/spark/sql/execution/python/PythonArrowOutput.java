...
public  interface PythonArrowOutput {
  public  scala.collection.Iterator<org.apache.spark.sql.vectorized.ColumnarBatch> newReaderIterator (java.io.DataInputStream stream, org.apache.spark.api.python.BasePythonRunner.WriterThread writerThread, long startTime, org.apache.spark.SparkEnv env, java.net.Socket worker, scala.Option<java.lang.Object> pid, java.util.concurrent.atomic.AtomicBoolean releasedOrClosed, org.apache.spark.TaskContext context)  ;
}
