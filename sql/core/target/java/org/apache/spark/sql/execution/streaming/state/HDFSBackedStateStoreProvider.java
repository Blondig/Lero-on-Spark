 ...
 */
  ...
  public  class HDFSBackedReadStateStore implements org.apache.spark.sql.execution.streaming.state.ReadStateStore {
    // not preceding
    public   HDFSBackedReadStateStore (long version, org.apache.spark.sql.execution.streaming.state.HDFSBackedStateStoreMap map)  { throw new RuntimeException(); }
  ...
  public  class HDFSBackedStateStore implements org.apache.spark.sql.execution.streaming.state.StateStore {
    ...
    // not preceding
    public   HDFSBackedStateStore (long version, org.apache.spark.sql.execution.streaming.state.HDFSBackedStateStoreMap mapToUpdate)  { throw new RuntimeException(); }
  ...
  /** This method is intended to be only used for unit test(s). DO NOT TOUCH ELEMENTS IN MAP! */
    java.util.SortedMap<java.lang.Object, org.apache.spark.sql.execution.streaming.state.HDFSBackedStateStoreMap> getLoadedMaps ()  { throw new RuntimeException(); }
