...
public  class ParquetScan implements org.apache.spark.sql.execution.datasources.v2.FileScan, scala.Product, scala.Serializable {
  ...
  public  scala.Option<org.apache.spark.sql.connector.expressions.aggregate.Aggregation> pushedAggregate ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   ParquetScan (org.apache.spark.sql.SparkSession sparkSession, org.apache.hadoop.conf.Configuration hadoopConf, org.apache.spark.sql.execution.datasources.PartitioningAwareFileIndex fileIndex, org.apache.spark.sql.types.StructType dataSchema, org.apache.spark.sql.types.StructType readDataSchema, org.apache.spark.sql.types.StructType readPartitionSchema, org.apache.spark.sql.sources.Filter[] pushedFilters, org.apache.spark.sql.util.CaseInsensitiveStringMap options, scala.Option<org.apache.spark.sql.connector.expressions.aggregate.Aggregation> pushedAggregate, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> partitionFilters, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> dataFilters)  { throw new RuntimeException(); }
