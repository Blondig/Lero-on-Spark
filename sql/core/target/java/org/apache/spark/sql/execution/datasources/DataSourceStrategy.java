...
public  class DataSourceStrategy {
   ...
   * @return (undocumented)
   */
  static protected  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> normalizeExprs (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> exprs, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> attributes)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  static protected  scala.Option<org.apache.spark.sql.sources.Filter> translateRuntimeFilter (org.apache.spark.sql.catalyst.expressions.Expression expr)  { throw new RuntimeException(); }
  /**
  ...
  static protected  scala.Option<org.apache.spark.sql.connector.expressions.aggregate.AggregateFunc> translateAggregate (org.apache.spark.sql.catalyst.expressions.aggregate.AggregateExpression agg)  { throw new RuntimeException(); }
  /**
   * Translate aggregate expressions and group by expressions.
   * <p>
   * @return translated aggregation.
   * @param aggregates (undocumented)
   * @param groupBy (undocumented)
   */
  static protected  scala.Option<org.apache.spark.sql.connector.expressions.aggregate.Aggregation> translateAggregation (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.aggregate.AggregateExpression> aggregates, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> groupBy)  { throw new RuntimeException(); }
  static protected  scala.collection.Seq<org.apache.spark.sql.connector.expressions.SortOrder> translateSortOrders (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.SortOrder> sortOrders)  { throw new RuntimeException(); }
  /**
