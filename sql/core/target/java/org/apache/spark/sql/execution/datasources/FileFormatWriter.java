...
public  class FileFormatWriter {
  ...
  static public  class Empty2Null extends org.apache.spark.sql.catalyst.expressions.UnaryExpression implements org.apache.spark.sql.catalyst.expressions.String2StringExpression, scala.Product, scala.Serializable {
    ...
    protected  org.apache.spark.sql.execution.datasources.FileFormatWriter.Empty2Null withNewChildInternal (org.apache.spark.sql.catalyst.expressions.Expression newChild)  { throw new RuntimeException(); }
  }
  ...
  static public  class ConcurrentOutputWriterSpec implements scala.Product, scala.Serializable {
    public  int maxWriters ()  { throw new RuntimeException(); }
    public  scala.Function0<org.apache.spark.sql.execution.UnsafeExternalRowSorter> createSorter ()  { throw new RuntimeException(); }
    // not preceding
    public   ConcurrentOutputWriterSpec (int maxWriters, scala.Function0<org.apache.spark.sql.execution.UnsafeExternalRowSorter> createSorter)  { throw new RuntimeException(); }
  }
  static public  class ConcurrentOutputWriterSpec$ extends scala.runtime.AbstractFunction2<java.lang.Object, scala.Function0<org.apache.spark.sql.execution.UnsafeExternalRowSorter>, org.apache.spark.sql.execution.datasources.FileFormatWriter.ConcurrentOutputWriterSpec> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final ConcurrentOutputWriterSpec$ MODULE$ = null;
    public   ConcurrentOutputWriterSpec$ ()  { throw new RuntimeException(); }
  }
  /**
   ...
   * @param jobCommitDuration (undocumented)
   */
  static   void processStats (scala.collection.Seq<org.apache.spark.sql.execution.datasources.WriteJobStatsTracker> statsTrackers, scala.collection.Seq<scala.collection.Seq<org.apache.spark.sql.execution.datasources.WriteTaskStats>> statsPerTask, long jobCommitDuration)  { throw new RuntimeException(); }
