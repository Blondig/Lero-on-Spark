...
public  interface WindowExecBase extends org.apache.spark.sql.execution.UnaryExecNode {
  ...
  public  scala.collection.Seq<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.SortOrder>> requiredChildOrdering ()  ;
   ...
   * {@link WindowExpression}s and factory function for the {@link WindowFunctionFrame}.
   * @return (undocumented)
   */
