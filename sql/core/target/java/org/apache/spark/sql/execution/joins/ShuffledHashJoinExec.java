...
public  class ShuffledHashJoinExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.joins.HashJoin, org.apache.spark.sql.execution.joins.ShuffledJoin, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ShuffledHashJoinExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> leftKeys, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> rightKeys, org.apache.spark.sql.catalyst.plans.JoinType joinType, org.apache.spark.sql.catalyst.optimizer.BuildSide buildSide, scala.Option<org.apache.spark.sql.catalyst.expressions.Expression> condition, org.apache.spark.sql.execution.SparkPlan left, org.apache.spark.sql.execution.SparkPlan right, boolean isSkewJoin)  { throw new RuntimeException(); }
  // not preceding
  ...
  // not preceding
  public  boolean ignoreDuplicatedKey ()  { throw new RuntimeException(); }
  /**
  ...
  protected  org.apache.spark.sql.execution.joins.ShuffledHashJoinExec withNewChildrenInternal (org.apache.spark.sql.execution.SparkPlan newLeft, org.apache.spark.sql.execution.SparkPlan newRight)  { throw new RuntimeException(); }
}
