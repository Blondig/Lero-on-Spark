...
public  class CartesianProductExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.joins.BaseJoinExec, scala.Product, scala.Serializable {
  ...
  protected  org.apache.spark.sql.execution.joins.CartesianProductExec withNewChildrenInternal (org.apache.spark.sql.execution.SparkPlan newLeft, org.apache.spark.sql.execution.SparkPlan newRight)  { throw new RuntimeException(); }
}
