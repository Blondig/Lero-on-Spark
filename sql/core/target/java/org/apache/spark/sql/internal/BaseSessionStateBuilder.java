...
public abstract class BaseSessionStateBuilder {
   ...
   * @return (undocumented)
   */
  protected  scala.Function2<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, scala.Enumeration.Value, org.apache.spark.sql.execution.QueryExecution> createQueryExecution ()  { throw new RuntimeException(); }
  /**
  ...
  // not preceding
  protected  org.apache.spark.sql.catalyst.analysis.TableFunctionRegistry tableFunctionRegistry ()  { throw new RuntimeException(); }
  /**
