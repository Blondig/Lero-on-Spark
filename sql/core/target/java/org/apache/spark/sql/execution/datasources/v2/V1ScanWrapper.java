...
public  class V1ScanWrapper implements org.apache.spark.sql.connector.read.Scan, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   V1ScanWrapper (org.apache.spark.sql.connector.read.V1Scan v1Scan, scala.collection.Seq<org.apache.spark.sql.sources.Filter> handledFilters, org.apache.spark.sql.execution.datasources.v2.PushedDownOperators pushedDownOperators)  { throw new RuntimeException(); }
