package org.apache.spark.sql.execution.datasources.jdbc;
  ...
  public  org.apache.spark.rdd.RDD<org.apache.spark.sql.Row> buildScan (java.lang.String[] requiredColumns, org.apache.spark.sql.types.StructType finalSchema, org.apache.spark.sql.connector.expressions.filter.Predicate[] predicates, scala.Option<java.lang.String[]> groupByColumns, scala.Option<org.apache.spark.sql.execution.datasources.v2.TableSampleInfo> tableSample, int limit, org.apache.spark.sql.connector.expressions.SortOrder[] sortOrders)  { throw new RuntimeException(); }
