...
public abstract class SparkPlan extends org.apache.spark.sql.catalyst.plans.QueryPlan<org.apache.spark.sql.execution.SparkPlan> implements org.apache.spark.internal.Logging, scala.Serializable {
  ...
  public final  org.apache.spark.sql.SparkSession session ()  { throw new RuntimeException(); }
   ...
   * can also support columnar execution (see <code>supportsColumnar</code>). Spark will decide
   * which execution to be called during query planning.
   * @return (undocumented)
   */
  public  boolean supportsRowBased ()  { throw new RuntimeException(); }
  /**
   * Return true if this stage of the plan supports columnar execution. A plan
   * can also support row-based execution (see <code>supportsRowBased</code>). Spark will decide
   * which execution to be called during query planning.
   * @return (undocumented)
   */
  ...
  public  scala.Option<scala.math.BigInt> sparkPlanRowCount ()  { throw new RuntimeException(); }
  public  scala.math.BigInt sparkPlanSizeInBytes ()  { throw new RuntimeException(); }
  ...
  public  boolean isRevised (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan p)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.execution.SparkPlan toRowBased ()  { throw new RuntimeException(); }
  /**
