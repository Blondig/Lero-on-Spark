...
public abstract class FileFormatDataWriter implements org.apache.spark.sql.connector.write.DataWriter<org.apache.spark.sql.catalyst.InternalRow> {
  public   FileFormatDataWriter (org.apache.spark.sql.execution.datasources.WriteJobDescription description, org.apache.hadoop.mapreduce.TaskAttemptContext taskAttemptContext, org.apache.spark.internal.io.FileCommitProtocol committer, scala.collection.immutable.Map<java.lang.String, org.apache.spark.sql.execution.metric.SQLMetric> customMetrics)  { throw new RuntimeException(); }
  /**
  ...
  protected  void releaseCurrentWriter ()  { throw new RuntimeException(); }
  ...
  public  void writeWithMetrics (org.apache.spark.sql.catalyst.InternalRow record, long count)  { throw new RuntimeException(); }
}
