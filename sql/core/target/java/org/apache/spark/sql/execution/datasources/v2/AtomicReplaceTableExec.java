...
public  class AtomicReplaceTableExec extends org.apache.spark.sql.execution.datasources.v2.V2CommandExec implements org.apache.spark.sql.execution.datasources.v2.LeafV2CommandExec, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   AtomicReplaceTableExec (org.apache.spark.sql.connector.catalog.StagingTableCatalog catalog, org.apache.spark.sql.connector.catalog.Identifier identifier, org.apache.spark.sql.types.StructType tableSchema, scala.collection.Seq<org.apache.spark.sql.connector.expressions.Transform> partitioning, org.apache.spark.sql.catalyst.plans.logical.TableSpec tableSpec, boolean orCreate, scala.Function3<org.apache.spark.sql.connector.catalog.TableCatalog, org.apache.spark.sql.connector.catalog.Table, org.apache.spark.sql.connector.catalog.Identifier, scala.runtime.BoxedUnit> invalidateCache)  { throw new RuntimeException(); }
