...
public  class ResolveSessionCatalog extends org.apache.spark.sql.catalyst.rules.Rule<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> implements org.apache.spark.sql.connector.catalog.LookupCatalog {
  ...
  public  class ResolvedV1TableAndIdentifier {
    static public  scala.Option<scala.Tuple2<org.apache.spark.sql.connector.catalog.V1Table, org.apache.spark.sql.connector.catalog.Identifier>> unapply (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan resolved)  { throw new RuntimeException(); }
  }
  public  class ResolvedV1TableAndIdentifier$ {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final ResolvedV1TableAndIdentifier$ MODULE$ = null;
    public   ResolvedV1TableAndIdentifier$ ()  { throw new RuntimeException(); }
    public  scala.Option<scala.Tuple2<org.apache.spark.sql.connector.catalog.V1Table, org.apache.spark.sql.connector.catalog.Identifier>> unapply (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan resolved)  { throw new RuntimeException(); }
  }
  ...
  public  org.apache.spark.sql.catalyst.analysis.ResolveSessionCatalog.ResolvedV1TableAndIdentifier$ ResolvedV1TableAndIdentifier ()  { throw new RuntimeException(); }
