...
public  class DataWritingCommand$ {
  ...
  /**
   * When execute CTAS operators, and the location is not empty, throw {@link AnalysisException}.
   * For CTAS, the SaveMode is always {@link ErrorIfExists}
   * <p>
   * @param tablePath Table location.
   * @param saveMode  Save mode of the table.
   * @param hadoopConf Configuration.
   */
  public  void assertEmptyRootPath (java.net.URI tablePath, org.apache.spark.sql.SaveMode saveMode, org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
}
