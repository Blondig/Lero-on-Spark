...
public  class CacheTableAsSelectExec extends org.apache.spark.sql.execution.datasources.v2.V2CommandExec implements org.apache.spark.sql.execution.datasources.v2.BaseCacheTableExec, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   CacheTableAsSelectExec (java.lang.String tempViewName, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query, java.lang.String originalText, boolean isLazy, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, scala.collection.Seq<java.lang.String> referredTempFunctions)  { throw new RuntimeException(); }
  // not preceding
