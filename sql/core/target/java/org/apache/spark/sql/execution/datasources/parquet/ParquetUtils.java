...
public  class ParquetUtils {
   ...
   * @return (undocumented)
   */
  static public  java.lang.String FIELD_ID_METADATA_KEY ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  boolean hasFieldIds (org.apache.spark.sql.types.StructType schema)  { throw new RuntimeException(); }
  static public  boolean hasFieldId (org.apache.spark.sql.types.StructField field)  { throw new RuntimeException(); }
  static public  int getFieldId (org.apache.spark.sql.types.StructField field)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  boolean isBatchReadSupportedForSchema (org.apache.spark.sql.internal.SQLConf sqlConf, org.apache.spark.sql.types.StructType schema)  { throw new RuntimeException(); }
  static public  boolean isBatchReadSupported (org.apache.spark.sql.internal.SQLConf sqlConf, org.apache.spark.sql.types.DataType dt)  { throw new RuntimeException(); }
  /**
