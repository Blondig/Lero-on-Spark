...
public  class OrcDeserializer {
  ...
  public  org.apache.spark.sql.catalyst.InternalRow deserializeFromValues (scala.collection.Seq<org.apache.hadoop.io.WritableComparable<?>> orcValues)  { throw new RuntimeException(); }
}
