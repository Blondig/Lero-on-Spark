...
public  class WriteJobDescription implements scala.Serializable {
  // not preceding
  public   WriteJobDescription (java.lang.String uuid, org.apache.spark.util.SerializableConfiguration serializableHadoopConf, org.apache.spark.sql.execution.datasources.OutputWriterFactory outputWriterFactory, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> allColumns, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> dataColumns, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> partitionColumns, scala.Option<org.apache.spark.sql.execution.datasources.WriterBucketSpec> bucketSpec, java.lang.String path, scala.collection.immutable.Map<scala.collection.immutable.Map<java.lang.String, java.lang.String>, java.lang.String> customPartitionLocations, long maxRecordsPerFile, java.lang.String timeZoneId, scala.collection.Seq<org.apache.spark.sql.execution.datasources.WriteJobStatsTracker> statsTrackers)  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> allColumns ()  { throw new RuntimeException(); }
  public  scala.Option<org.apache.spark.sql.execution.datasources.WriterBucketSpec> bucketSpec ()  { throw new RuntimeException(); }
