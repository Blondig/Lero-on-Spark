...
public  class ClearCacheCommand {
  ...
  static public final  scala.collection.Seq<scala.Enumeration.Value> nodePatterns ()  { throw new RuntimeException(); }
  ...
  static public final  boolean containsPattern (scala.Enumeration.Value t)  { throw new RuntimeException(); }
  static public final  boolean containsAllPatterns (scala.collection.Seq<scala.Enumeration.Value> patterns)  { throw new RuntimeException(); }
  static public final  boolean containsAnyPattern (scala.collection.Seq<scala.Enumeration.Value> patterns)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.trees.Origin origin ()  { throw new RuntimeException(); }
  static protected  org.apache.spark.util.collection.BitSet getDefaultTreePatternBits ()  { throw new RuntimeException(); }
  static protected  void markRuleAsIneffective (org.apache.spark.sql.catalyst.rules.RuleId ruleId)  { throw new RuntimeException(); }
  static protected  boolean isRuleIneffective (org.apache.spark.sql.catalyst.rules.RuleId ruleId)  { throw new RuntimeException(); }
  ...
  static public  boolean exists (scala.Function1<BaseType, java.lang.Object> f)  { throw new RuntimeException(); }
  ...
  static public final  BaseType withNewChildren (scala.collection.Seq<BaseType> newChildren)  { throw new RuntimeException(); }
  static protected abstract  BaseType withNewChildrenInternal (scala.collection.IndexedSeq<BaseType> newChildren)  ;
  static protected final  BaseType legacyWithNewChildren (scala.collection.Seq<BaseType> newChildren)  { throw new RuntimeException(); }
  static public  BaseType transform (scala.PartialFunction<BaseType, BaseType> rule)  { throw new RuntimeException(); }
  static public  BaseType transformWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<BaseType, BaseType> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId transformWithPruning$default$2 ()  { throw new RuntimeException(); }
  ...
  static public  BaseType transformUpWithBeforeAndAfterRuleOnChildren (scala.Function1<BaseType, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<scala.Tuple2<BaseType, BaseType>, BaseType> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId transformUpWithBeforeAndAfterRuleOnChildren$default$2 ()  { throw new RuntimeException(); }
  ...
  static public  java.lang.String jsonWithStats ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.util.collection.BitSet treePatternBits ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.plans.QueryPlan<PlanType> transformExpressionsWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.expressions.Expression, org.apache.spark.sql.catalyst.expressions.Expression> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId transformExpressionsWithPruning$default$2 ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.plans.QueryPlan<PlanType> transformExpressionsDownWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.expressions.Expression, org.apache.spark.sql.catalyst.expressions.Expression> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId transformExpressionsDownWithPruning$default$2 ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.plans.QueryPlan<PlanType> transformExpressionsUpWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.expressions.Expression, org.apache.spark.sql.catalyst.expressions.Expression> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId transformExpressionsUpWithPruning$default$2 ()  { throw new RuntimeException(); }
  ...
  static public  PlanType rewriteAttrs (org.apache.spark.sql.catalyst.expressions.AttributeMap<org.apache.spark.sql.catalyst.expressions.Attribute> attrMap)  { throw new RuntimeException(); }
  ...
  static public  PlanType transformWithSubqueries (scala.PartialFunction<PlanType, PlanType> f)  { throw new RuntimeException(); }
  static public  PlanType transformUpWithSubqueries (scala.PartialFunction<PlanType, PlanType> f)  { throw new RuntimeException(); }
  static public  PlanType transformDownWithSubqueries (scala.PartialFunction<PlanType, PlanType> f)  { throw new RuntimeException(); }
  static public  PlanType transformDownWithSubqueriesAndPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<PlanType, PlanType> f)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId transformDownWithSubqueriesAndPruning$default$2 ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan resolveOperatorsWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId resolveOperatorsWithPruning$default$2 ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan resolveOperatorsUpWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId resolveOperatorsUpWithPruning$default$2 ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan resolveOperatorsDownWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId resolveOperatorsDownWithPruning$default$2 ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan updateOuterReferencesInSubquery (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan, org.apache.spark.sql.catalyst.expressions.AttributeMap<org.apache.spark.sql.catalyst.expressions.Attribute> attrMap)  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan resolveExpressionsWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.expressions.Expression, org.apache.spark.sql.catalyst.expressions.Expression> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId resolveExpressionsWithPruning$default$2 ()  { throw new RuntimeException(); }
  static protected  void assertNotAnalysisRule ()  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan transformDownWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId transformDownWithPruning$default$2 ()  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan transformUpWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId transformUpWithPruning$default$2 ()  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.plans.logical.AnalysisHelper transformAllExpressionsWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.expressions.Expression, org.apache.spark.sql.catalyst.expressions.Expression> rule)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.rules.RuleId transformAllExpressionsWithPruning$default$2 ()  { throw new RuntimeException(); }
  ...
  static protected  scala.collection.immutable.List<scala.Tuple2<java.lang.String, org.json4s.JsonAST.JValue>> jsonFieldsWithStatsAppend ()  { throw new RuntimeException(); }
  ...
  static public  scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.ExpressionSet> distinctKeys ()  { throw new RuntimeException(); }
  ...
  static protected abstract  void org$apache$spark$sql$catalyst$plans$logical$Command$_setter_$nodePatterns_$eq (scala.collection.Seq<scala.Enumeration.Value> x$1)  ;
  ...
  static public final  scala.collection.Seq<T> children ()  { throw new RuntimeException(); }
  static public final  T mapChildren (scala.Function1<T, T> f)  { throw new RuntimeException(); }
  static public final  T withNewChildrenInternal (scala.collection.IndexedSeq<T> newChildren)  { throw new RuntimeException(); }
}
