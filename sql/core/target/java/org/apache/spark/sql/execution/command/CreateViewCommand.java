 ...
 */
public  class CreateViewCommand extends org.apache.spark.sql.catalyst.plans.logical.LogicalPlan implements org.apache.spark.sql.execution.command.RunnableCommand, org.apache.spark.sql.catalyst.plans.logical.AnalysisOnlyCommand, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   CreateViewCommand (org.apache.spark.sql.catalyst.TableIdentifier name, scala.collection.Seq<scala.Tuple2<java.lang.String, scala.Option<java.lang.String>>> userSpecifiedColumns, scala.Option<java.lang.String> comment, scala.collection.immutable.Map<java.lang.String, java.lang.String> properties, scala.Option<java.lang.String> originalText, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan, boolean allowExisting, boolean replace, org.apache.spark.sql.catalyst.analysis.ViewType viewType, boolean isAnalyzed, scala.collection.Seq<java.lang.String> referredTempFunctions)  { throw new RuntimeException(); }
  protected  org.apache.spark.sql.execution.command.CreateViewCommand withNewChildrenInternal (scala.collection.IndexedSeq<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> newChildren)  { throw new RuntimeException(); }
