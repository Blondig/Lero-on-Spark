...
public  class SubExprUtils {
   ...
   * @return (undocumented)
   */
  static public <E extends org.apache.spark.sql.catalyst.expressions.Expression> E stripOuterReference (E e)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public <E extends org.apache.spark.sql.catalyst.expressions.Expression> scala.collection.Seq<E> stripOuterReferences (scala.collection.Seq<E> e)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Wrap attributes in the expression with {@link OuterReference}s.
   * @param e (undocumented)
   * @return (undocumented)
   */
  static public <E extends org.apache.spark.sql.catalyst.expressions.Expression> E wrapOuterReference (E e)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> getOuterReferences (org.apache.spark.sql.catalyst.expressions.Expression expr)  { throw new RuntimeException(); }
  /**
