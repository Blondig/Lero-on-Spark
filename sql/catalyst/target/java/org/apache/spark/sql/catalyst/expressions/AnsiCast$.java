...
public  class AnsiCast$ implements scala.Serializable {
  ...
  public  java.lang.String typeCheckFailureMessage (org.apache.spark.sql.types.DataType from, org.apache.spark.sql.types.DataType to, scala.Option<java.lang.String> fallbackConfKey, scala.Option<java.lang.String> fallbackConfValue)  { throw new RuntimeException(); }
}
