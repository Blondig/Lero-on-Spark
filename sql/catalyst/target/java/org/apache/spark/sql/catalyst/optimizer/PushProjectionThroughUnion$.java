...
public  class PushProjectionThroughUnion$ extends org.apache.spark.sql.catalyst.rules.Rule<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> implements org.apache.spark.sql.catalyst.expressions.PredicateHelper {
  ...
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> pushProjectionThroughUnion (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.NamedExpression> projectList, org.apache.spark.sql.catalyst.plans.logical.Union u)  { throw new RuntimeException(); }
