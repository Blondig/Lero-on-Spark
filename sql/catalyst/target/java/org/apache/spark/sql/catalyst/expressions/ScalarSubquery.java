...
public  class ScalarSubquery extends org.apache.spark.sql.catalyst.expressions.SubqueryExpression implements org.apache.spark.sql.catalyst.expressions.Unevaluable, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ScalarSubquery (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> outerAttrs, org.apache.spark.sql.catalyst.expressions.ExprId exprId, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> joinCond)  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.catalyst.expressions.ScalarSubquery withNewChildrenInternal (scala.collection.IndexedSeq<org.apache.spark.sql.catalyst.expressions.Expression> newChildren)  { throw new RuntimeException(); }
