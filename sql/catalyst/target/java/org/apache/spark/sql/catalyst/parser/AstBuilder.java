 ...
 * TableIdentifier.
 */
public  class AstBuilder extends org.apache.spark.sql.catalyst.parser.SqlBaseParserBaseVisitor<java.lang.Object> implements org.apache.spark.sql.catalyst.SQLConfHelper, org.apache.spark.internal.Logging {
  ...
  protected  scala.collection.Seq<java.lang.String> getFunctionMultiparts (org.apache.spark.sql.catalyst.parser.SqlBaseParser.FunctionNameContext ctx)  { throw new RuntimeException(); }
  ...
  /**
   * Parse a {@link AlterTableAddColumns} command.
   * <p>
   * For example:
   * <pre><code>
   *   ALTER TABLE table1
  ...
  /**
   * Parse a {@link AlterTableAlterColumn} command to alter a column's property.
   * <p>
   * For example:
   * <pre><code>
  ...
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan visitCommonSelectQueryClausePlan (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan relation, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> expressions, java.util.List<org.apache.spark.sql.catalyst.parser.SqlBaseParser.LateralViewContext> lateralView, org.apache.spark.sql.catalyst.parser.SqlBaseParser.WhereClauseContext whereClause, org.apache.spark.sql.catalyst.parser.SqlBaseParser.AggregationClauseContext aggregationClause, org.apache.spark.sql.catalyst.parser.SqlBaseParser.HavingClauseContext havingClause, org.apache.spark.sql.catalyst.parser.SqlBaseParser.WindowClauseContext windowClause, boolean isDistinct)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Create an index, returning a {@link CreateIndex} logical plan.
   * For example:
   * <pre><code>
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan visitCreateIndex (org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateIndexContext ctx)  { throw new RuntimeException(); }
  /**
   * Create a {@link CreateNamespace} command.
   * <p>
   * For example:
   * <pre><code>
  ...
  /**
   * Create a table, returning a {@link CreateTable} or {@link CreateTableAsSelect} logical plan.
   * <p>
   * Expected format:
   * <pre><code>
  ...
  public  org.apache.spark.sql.catalyst.expressions.Expression visitCurrentLike (org.apache.spark.sql.catalyst.parser.SqlBaseParser.CurrentLikeContext ctx)  { throw new RuntimeException(); }
  public  org.apache.spark.sql.types.DataType visitDayTimeIntervalDataType (org.apache.spark.sql.catalyst.parser.SqlBaseParser.DayTimeIntervalDataTypeContext ctx)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Drop an index, returning a {@link DropIndex} logical plan.
   * For example:
   * <pre><code>
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan visitDropIndex (org.apache.spark.sql.catalyst.parser.SqlBaseParser.DropIndexContext ctx)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Parse a {@link AlterTableDropColumns} command.
   * <p>
   * For example:
   * <pre><code>
  ...
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> visitExpressionSeq (org.apache.spark.sql.catalyst.parser.SqlBaseParser.ExpressionSeqContext ctx)  { throw new RuntimeException(); }
  /**
  ...
  public  org.apache.spark.sql.catalyst.expressions.BaseGroupingSets visitGroupingAnalytics (org.apache.spark.sql.catalyst.parser.SqlBaseParser.GroupingAnalyticsContext groupingAnalytics)  { throw new RuntimeException(); }
  /**
   * Parse a {@link AlterTableAlterColumn} command. This is Hive SQL syntax.
   * <p>
   * For example:
   * <pre><code>
  ...
  /**
   * Create a {@link CalendarInterval} or ANSI interval literal expression.
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.expressions.Expression visitPercentile (org.apache.spark.sql.catalyst.parser.SqlBaseParser.PercentileContext ctx)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String visitPropertyKey (org.apache.spark.sql.catalyst.parser.SqlBaseParser.PropertyKeyContext key)  { throw new RuntimeException(); }
  /**
   * Parse a key-value map from a {@link PropertyListContext}, assuming all values are specified.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  public  scala.collection.immutable.Map<java.lang.String, java.lang.String> visitPropertyKeyValues (org.apache.spark.sql.catalyst.parser.SqlBaseParser.PropertyListContext ctx)  { throw new RuntimeException(); }
  /**
   * Parse a list of keys from a {@link PropertyListContext}, assuming no values are specified.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  public  scala.collection.Seq<java.lang.String> visitPropertyKeys (org.apache.spark.sql.catalyst.parser.SqlBaseParser.PropertyListContext ctx)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Map<java.lang.String, java.lang.String> visitPropertyList (org.apache.spark.sql.catalyst.parser.SqlBaseParser.PropertyListContext ctx)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String visitPropertyValue (org.apache.spark.sql.catalyst.parser.SqlBaseParser.PropertyValueContext value)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Parse a {@link AlterTableRenameColumn} command.
   * <p>
   * For example:
   * <pre><code>
  ...
  /**
   * Replace a table, returning a {@link ReplaceTable} or {@link ReplaceTableAsSelect}
   * logical plan.
   * <p>
   * Expected format:
   * <pre><code>
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.expressions.Expression visitTimestampadd (org.apache.spark.sql.catalyst.parser.SqlBaseParser.TimestampaddContext ctx)  { throw new RuntimeException(); }
  /**
   * Create a TimestampDiff expression.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.expressions.Expression visitTimestampdiff (org.apache.spark.sql.catalyst.parser.SqlBaseParser.TimestampdiffContext ctx)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Create a {@link SetCatalogAndNamespace} command.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  ...
  public  org.apache.spark.sql.types.DataType visitYearMonthIntervalDataType (org.apache.spark.sql.catalyst.parser.SqlBaseParser.YearMonthIntervalDataTypeContext ctx)  { throw new RuntimeException(); }
  /**
