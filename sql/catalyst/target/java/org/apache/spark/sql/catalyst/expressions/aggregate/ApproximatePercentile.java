 ...
 */
public  class ApproximatePercentile extends org.apache.spark.sql.catalyst.expressions.aggregate.TypedImperativeAggregate<org.apache.spark.sql.catalyst.expressions.aggregate.ApproximatePercentile.PercentileDigest> implements org.apache.spark.sql.catalyst.expressions.ImplicitCastInputTypes, org.apache.spark.sql.catalyst.trees.TernaryLike<org.apache.spark.sql.catalyst.expressions.Expression>, scala.Product, scala.Serializable {
  /**
  ...
  static public  class PercentileDigest {
     ...
     * @return (undocumented)
     */
    public  scala.collection.Seq<java.lang.Object> getPercentiles (double[] percentages)  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.catalyst.expressions.aggregate.ApproximatePercentile withNewChildrenInternal (org.apache.spark.sql.catalyst.expressions.Expression newFirst, org.apache.spark.sql.catalyst.expressions.Expression newSecond, org.apache.spark.sql.catalyst.expressions.Expression newThird)  { throw new RuntimeException(); }
}
