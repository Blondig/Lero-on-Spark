...
public  class StructType extends org.apache.spark.sql.types.DataType implements scala.collection.Seq<org.apache.spark.sql.types.StructField>, scala.Product, scala.Serializable {
  ...
  /**
   * This leverages <code>merge</code> to merge data types for UNION operator by specializing
   * the handling of struct types to follow UNION semantics.
   * @param left (undocumented)
   * @param right (undocumented)
   * @return (undocumented)
   */
  static   org.apache.spark.sql.types.DataType unionLikeMerge (org.apache.spark.sql.types.DataType left, org.apache.spark.sql.types.DataType right)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
    scala.Option<scala.Tuple2<scala.collection.Seq<java.lang.String>, org.apache.spark.sql.types.StructField>> findNestedField (scala.collection.Seq<java.lang.String> fieldNames, boolean includeCollections, scala.Function2<java.lang.String, java.lang.String, java.lang.Object> resolver, org.apache.spark.sql.catalyst.trees.Origin context)  { throw new RuntimeException(); }
