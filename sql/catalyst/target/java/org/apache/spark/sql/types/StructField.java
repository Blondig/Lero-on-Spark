...
public  class StructField implements scala.Product, scala.Serializable {
   ...
   * <code>StructField("eventId", IntegerType, false)</code> will be converted to <code>eventId</code> INT NOT NULL.
   * <code>StructField("eventId", IntegerType, true)</code> will be converted to <code>eventId</code> INT.
   * @since 2.4.0
   * @return (undocumented)
   */
