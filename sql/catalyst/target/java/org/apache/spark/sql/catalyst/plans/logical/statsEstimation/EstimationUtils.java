...
public  class EstimationUtils {
   ...
   * @param oldStatOpt (undocumented)
   * @param updatedStatOpt (undocumented)
   * @return (undocumented)
   */
  static public  scala.Option<scala.math.BigInt> updateStat (scala.math.BigInt oldNumRows, scala.math.BigInt newNumRows, scala.Option<scala.math.BigInt> oldStatOpt, scala.Option<scala.math.BigInt> updatedStatOpt)  { throw new RuntimeException(); }
