...
public  class FakeV2SessionCatalog {
  ...
  static public  org.apache.spark.sql.connector.catalog.Identifier[] listFunctions (java.lang.String[] namespace)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.connector.catalog.functions.UnboundFunction loadFunction (org.apache.spark.sql.connector.catalog.Identifier ident)  { throw new RuntimeException(); }
  // not preceding
  ...
  static public  boolean purgeTable (org.apache.spark.sql.connector.catalog.Identifier ident)  { throw new RuntimeException(); }
  static public  boolean functionExists (org.apache.spark.sql.connector.catalog.Identifier ident)  { throw new RuntimeException(); }
}
