...
public  class SessionCatalog implements org.apache.spark.sql.catalyst.SQLConfHelper, org.apache.spark.internal.Logging {
  ...
  public   SessionCatalog (scala.Function0<org.apache.spark.sql.catalyst.catalog.ExternalCatalog> externalCatalogBuilder, scala.Function0<org.apache.spark.sql.catalyst.catalog.GlobalTempViewManager> globalTempViewManagerBuilder, org.apache.spark.sql.catalyst.analysis.FunctionRegistry functionRegistry, org.apache.spark.sql.catalyst.analysis.TableFunctionRegistry tableFunctionRegistry, org.apache.hadoop.conf.Configuration hadoopConf, org.apache.spark.sql.catalyst.parser.ParserInterface parser, org.apache.spark.sql.catalyst.catalog.FunctionResourceLoader functionResourceLoader, org.apache.spark.sql.catalyst.catalog.FunctionExpressionBuilder functionExpressionBuilder, int cacheSize, long cacheTTL)  { throw new RuntimeException(); }
  public   SessionCatalog (org.apache.spark.sql.catalyst.catalog.ExternalCatalog externalCatalog, org.apache.spark.sql.catalyst.analysis.FunctionRegistry functionRegistry, org.apache.spark.sql.catalyst.analysis.TableFunctionRegistry tableFunctionRegistry, org.apache.spark.sql.internal.SQLConf conf)  { throw new RuntimeException(); }
  ...
  public   SessionCatalog (org.apache.spark.sql.catalyst.catalog.ExternalCatalog externalCatalog, org.apache.spark.sql.catalyst.analysis.FunctionRegistry functionRegistry, org.apache.spark.sql.catalyst.analysis.TableFunctionRegistry tableFunctionRegistry)  { throw new RuntimeException(); }
  ...
  protected  scala.collection.mutable.HashMap<java.lang.String, org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation> tempViews ()  { throw new RuntimeException(); }
   ...
   */
  public  void createTempView (java.lang.String name, org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation viewDefinition, boolean overrideIfExists)  { throw new RuntimeException(); }
  /**
   ...
   * @param overrideIfExists (undocumented)
   */
  public  void createGlobalTempView (java.lang.String name, org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation viewDefinition, boolean overrideIfExists)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean alterTempViewDefinition (org.apache.spark.sql.catalyst.TableIdentifier name, org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation viewDefinition)  { throw new RuntimeException(); }
  /**
   * Return a local temporary view exactly as it was stored.
   * @param name (undocumented)
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation> getRawTempView (java.lang.String name)  { throw new RuntimeException(); }
  /**
   * Generate a {@link View} operator from the temporary view stored.
   * @param name (undocumented)
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.sql.catalyst.plans.logical.View> getTempView (java.lang.String name)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation> getRawGlobalTempView (java.lang.String name)  { throw new RuntimeException(); }
  /**
   * Generate a {@link View} operator from the global temporary view stored.
   * @param name (undocumented)
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.sql.catalyst.plans.logical.View> getGlobalTempView (java.lang.String name)  { throw new RuntimeException(); }
  /**
  ...
  public  scala.Option<org.apache.spark.sql.catalyst.plans.logical.View> lookupTempView (org.apache.spark.sql.catalyst.TableIdentifier name)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Registers a temporary or permanent scalar function into a session-specific {@link FunctionRegistry}
   * @param funcDefinition (undocumented)
   * @param overrideIfExists (undocumented)
   ...
   * @return (undocumented)
   */
  public  boolean isBuiltinFunction (org.apache.spark.sql.catalyst.FunctionIdentifier name)  { throw new RuntimeException(); }
  ...
  /**
   * Look up the <code>ExpressionInfo</code> of the given function by name if it's a built-in or temp function.
   * This only supports scalar functions.
   * @param name (undocumented)
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.sql.catalyst.expressions.ExpressionInfo> lookupBuiltinOrTempFunction (java.lang.String name)  { throw new RuntimeException(); }
  /**
   * Look up the <code>ExpressionInfo</code> of the given function by name if it's a built-in or
   * temp table function.
   * @param name (undocumented)
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.sql.catalyst.expressions.ExpressionInfo> lookupBuiltinOrTempTableFunction (java.lang.String name)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.sql.catalyst.expressions.Expression> resolveBuiltinOrTempFunction (java.lang.String name, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> arguments)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> resolveBuiltinOrTempTableFunction (java.lang.String name, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> arguments)  { throw new RuntimeException(); }
  /**
   * Look up the <code>ExpressionInfo</code> of the given function by name if it's a persistent function.
   * This supports both scalar and table functions.
   * @param name (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.expressions.ExpressionInfo lookupPersistentFunction (org.apache.spark.sql.catalyst.FunctionIdentifier name)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.expressions.Expression resolvePersistentFunction (org.apache.spark.sql.catalyst.FunctionIdentifier name, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> arguments)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan resolvePersistentTableFunction (org.apache.spark.sql.catalyst.FunctionIdentifier name, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> arguments)  { throw new RuntimeException(); }
  /**
  ...
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan lookupTableFunction (org.apache.spark.sql.catalyst.FunctionIdentifier name, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> children)  { throw new RuntimeException(); }
  /**
