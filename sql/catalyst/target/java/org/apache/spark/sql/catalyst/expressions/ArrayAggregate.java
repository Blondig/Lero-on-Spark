 ...
 */
public  class ArrayAggregate extends org.apache.spark.sql.catalyst.expressions.Expression implements org.apache.spark.sql.catalyst.expressions.HigherOrderFunction, org.apache.spark.sql.catalyst.expressions.codegen.CodegenFallback, org.apache.spark.sql.catalyst.trees.QuaternaryLike<org.apache.spark.sql.catalyst.expressions.Expression>, scala.Product, scala.Serializable {
  ...
  protected  org.apache.spark.sql.catalyst.expressions.ArrayAggregate withNewChildrenInternal (org.apache.spark.sql.catalyst.expressions.Expression first, org.apache.spark.sql.catalyst.expressions.Expression second, org.apache.spark.sql.catalyst.expressions.Expression third, org.apache.spark.sql.catalyst.expressions.Expression fourth)  { throw new RuntimeException(); }
}
