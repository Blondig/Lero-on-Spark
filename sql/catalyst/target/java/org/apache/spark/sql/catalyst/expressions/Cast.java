...
public  class Cast extends org.apache.spark.sql.catalyst.expressions.CastBase implements scala.Product, scala.Serializable {
  ...
  public   Cast (org.apache.spark.sql.catalyst.expressions.Expression child, org.apache.spark.sql.types.DataType dataType, scala.Option<java.lang.String> timeZoneId, boolean ansiEnabled)  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.catalyst.expressions.Cast withNewChildInternal (org.apache.spark.sql.catalyst.expressions.Expression newChild)  { throw new RuntimeException(); }
}
