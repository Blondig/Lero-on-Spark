...
public  class NewInstance extends org.apache.spark.sql.catalyst.expressions.Expression implements org.apache.spark.sql.catalyst.expressions.objects.InvokeLike, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   NewInstance (java.lang.Class<?> cls, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> arguments, scala.collection.Seq<org.apache.spark.sql.types.AbstractDataType> inputTypes, boolean propagateNull, org.apache.spark.sql.types.DataType dataType, scala.Option<scala.Function0<java.lang.Object>> outerPointer)  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.catalyst.expressions.objects.NewInstance withNewChildrenInternal (scala.collection.IndexedSeq<org.apache.spark.sql.catalyst.expressions.Expression> newChildren)  { throw new RuntimeException(); }
}
