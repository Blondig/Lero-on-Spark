...
public  class CatalogV2Util$ {
  ...
  public  scala.Option<org.apache.spark.sql.connector.catalog.Table> loadTable (org.apache.spark.sql.connector.catalog.CatalogPlugin catalog, org.apache.spark.sql.connector.catalog.Identifier ident, scala.Option<org.apache.spark.sql.catalyst.analysis.TimeTravelSpec> timeTravelSpec)  { throw new RuntimeException(); }
  public  scala.Option<org.apache.spark.sql.connector.catalog.functions.UnboundFunction> loadFunction (org.apache.spark.sql.connector.catalog.CatalogPlugin catalog, org.apache.spark.sql.connector.catalog.Identifier ident)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Map<java.lang.String, java.lang.String> convertTableProperties (org.apache.spark.sql.catalyst.plans.logical.TableSpec t)  { throw new RuntimeException(); }
