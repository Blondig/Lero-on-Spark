...
public  class SchemaUtils {
   ...
   */
  static public  void checkSchemaColumnNameDuplication (org.apache.spark.sql.types.DataType schema, java.lang.String colType, boolean caseSensitiveAnalysis)  { throw new RuntimeException(); }
  /**
   * Checks if an input schema has duplicate column names. This throws an exception if the
   * duplication exists.
   * <p>
   ...
   */
  static public  void checkSchemaColumnNameDuplication (org.apache.spark.sql.types.StructType schema, java.lang.String colType, scala.Function2<java.lang.String, java.lang.String, java.lang.Object> resolver)  { throw new RuntimeException(); }
  /**
  ...
  static public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.NamedExpression> restoreOriginalOutputNames (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.NamedExpression> projectList, scala.collection.Seq<java.lang.String> originalNames)  { throw new RuntimeException(); }
  /**
   * @param str The string to be escaped.
   * @return The escaped string.
   */
  static public  java.lang.String escapeMetaCharacters (java.lang.String str)  { throw new RuntimeException(); }
}
