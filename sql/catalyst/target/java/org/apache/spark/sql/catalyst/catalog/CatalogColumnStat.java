...
public  class CatalogColumnStat implements scala.Product, scala.Serializable {
  ...
  static public  org.apache.spark.sql.catalyst.util.TimestampFormatter getTimestampFormatter (boolean isParsing, java.lang.String format, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
