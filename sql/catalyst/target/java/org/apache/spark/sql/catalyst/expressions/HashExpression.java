 ...
 *  - calendar interval:       hash <code>microseconds</code> first, and use the result as seed
 *                             to hash <code>months</code>.
 *  - interval day to second:  it store long value of <code>microseconds</code>, use murmur3 to hash the long
 *                             input with seed.
 *  - interval year to month:  it store int value of <code>months</code>, use murmur3 to hash the int
 *                             input with seed.
