...
public abstract class QueryPlan<PlanType extends org.apache.spark.sql.catalyst.plans.QueryPlan<PlanType>> extends org.apache.spark.sql.catalyst.trees.TreeNode<PlanType> implements org.apache.spark.sql.catalyst.SQLConfHelper {
  ...
  /**
   * Runs {@link transformExpressionsDownWithPruning} with <code>rule</code> on all expressions present
   * in this query operator.
   * Users should not expect a specific directionality. If a specific directionality is needed,
   * transformExpressionsDown or transformExpressionsUp should be used.
   * <p>
  ...
  /**
   * Runs {@link transformDownWithPruning} with <code>rule</code> on all expressions present in this query
   * operator.
   * <p>
   * @param rule   the rule to be applied to every expression in this operator.
   * @param cond   a Lambda expression to prune tree traversals. If <code>cond.apply</code> returns false
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.QueryPlan<PlanType> transformExpressionsDownWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.expressions.Expression, org.apache.spark.sql.catalyst.expressions.Expression> rule)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Runs {@link transformExpressionsUpWithPruning} with <code>rule</code> on all expressions present in this
   * query operator.
   * <p>
   * @param rule the rule to be applied to every expression in this operator.
   * @param cond   a Lambda expression to prune tree traversals. If <code>cond.apply</code> returns false
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.QueryPlan<PlanType> transformExpressionsUpWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.expressions.Expression, org.apache.spark.sql.catalyst.expressions.Expression> rule)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Returns the result of running {@link transformExpressionsWithPruning} on this node
   * and all its children. Note that this method skips expressions inside subqueries.
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.QueryPlan<PlanType> transformAllExpressionsWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<org.apache.spark.sql.catalyst.expressions.Expression, org.apache.spark.sql.catalyst.expressions.Expression> rule)  { throw new RuntimeException(); }
  ...
  public  PlanType rewriteAttrs (org.apache.spark.sql.catalyst.expressions.AttributeMap<org.apache.spark.sql.catalyst.expressions.Attribute> attrMap)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  protected  PlanType updateOuterReferencesInSubquery (PlanType plan, org.apache.spark.sql.catalyst.expressions.AttributeMap<org.apache.spark.sql.catalyst.expressions.Attribute> attrMap)  { throw new RuntimeException(); }
  // not preceding
   ...
   * @return (undocumented)
   */
  public  PlanType transformWithSubqueries (scala.PartialFunction<PlanType, PlanType> f)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  PlanType transformUpWithSubqueries (scala.PartialFunction<PlanType, PlanType> f)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  PlanType transformDownWithSubqueries (scala.PartialFunction<PlanType, PlanType> f)  { throw new RuntimeException(); }
  /**
   * This method is the top-down (pre-order) counterpart of transformUpWithSubqueries.
   * Returns a copy of this node where the given partial function has been recursively applied
   * first to this node, then this node's subqueries and finally this node's children.
   ...
   * @return (undocumented)
   */
  public  PlanType transformDownWithSubqueriesAndPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<PlanType, PlanType> f)  { throw new RuntimeException(); }
  /**
