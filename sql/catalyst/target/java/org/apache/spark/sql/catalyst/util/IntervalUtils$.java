...
public  class IntervalUtils$ {
  ...
  public  int getYears (int months)  { throw new RuntimeException(); }
  public  int getYears (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  public  byte getMonths (int months)  { throw new RuntimeException(); }
  public  byte getMonths (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  public  int getDays (long microseconds)  { throw new RuntimeException(); }
  public  int getDays (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  public  byte getHours (long microseconds)  { throw new RuntimeException(); }
  public  byte getHours (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  public  byte getMinutes (long microseconds)  { throw new RuntimeException(); }
  public  byte getMinutes (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  public  org.apache.spark.sql.types.Decimal getSeconds (long microseconds)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Map<scala.Tuple2<java.lang.Object, java.lang.Object>, scala.collection.Seq<java.lang.String>> supportedFormat ()  { throw new RuntimeException(); }
  public  int castStringToYMInterval (org.apache.spark.unsafe.types.UTF8String input, byte startField, byte endField)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.unsafe.types.CalendarInterval fromYearMonthString (java.lang.String input, byte startField, byte endField)  { throw new RuntimeException(); }
  public  long castStringToDTInterval (org.apache.spark.unsafe.types.UTF8String input, byte startField, byte endField)  { throw new RuntimeException(); }
  public  long toDTInterval (java.lang.String day, java.lang.String hour, java.lang.String minute, java.lang.String second, int sign)  { throw new RuntimeException(); }
  public  long toDTInterval (java.lang.String hour, java.lang.String minute, java.lang.String second, int sign)  { throw new RuntimeException(); }
  public  long toDTInterval (java.lang.String minute, java.lang.String second, int sign)  { throw new RuntimeException(); }
  public  org.apache.spark.unsafe.types.CalendarInterval castDayTimeStringToInterval (java.lang.String input, byte startField, byte endField)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.unsafe.types.CalendarInterval fromDayTimeString (java.lang.String input, byte from, byte to)  { throw new RuntimeException(); }
  /**
   * Parse all kinds of interval literals including unit-to-unit form and unit list form
   * @param input (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.unsafe.types.CalendarInterval fromIntervalString (java.lang.String input)  { throw new RuntimeException(); }
  /**
  ...
  public  long makeDayTimeInterval (int days, int hours, int mins, org.apache.spark.sql.types.Decimal secs)  { throw new RuntimeException(); }
  /**
  ...
  public  long durationToMicros (java.time.Duration duration, byte endField)  { throw new RuntimeException(); }
  /**
  ...
  public  int periodToMonths (java.time.Period period, byte endField)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  java.lang.String toYearMonthIntervalString (int months, scala.Enumeration.Value style, byte startField, byte endField)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  java.lang.String toDayTimeIntervalString (long micros, scala.Enumeration.Value style, byte startField, byte endField)  { throw new RuntimeException(); }
  public  int intToYearMonthInterval (int v, byte endField)  { throw new RuntimeException(); }
  public  int longToYearMonthInterval (long v, byte endField)  { throw new RuntimeException(); }
  public  int yearMonthIntervalToInt (int v, byte startField, byte endField)  { throw new RuntimeException(); }
  public  short yearMonthIntervalToShort (int v, byte startField, byte endField)  { throw new RuntimeException(); }
  public  byte yearMonthIntervalToByte (int v, byte startField, byte endField)  { throw new RuntimeException(); }
  public  long intToDayTimeInterval (int v, byte endField)  { throw new RuntimeException(); }
  public  long longToDayTimeInterval (long v, byte endField)  { throw new RuntimeException(); }
  public  long dayTimeIntervalToLong (long v, byte startField, byte endField)  { throw new RuntimeException(); }
  public  int dayTimeIntervalToInt (long v, byte startField, byte endField)  { throw new RuntimeException(); }
  public  short dayTimeIntervalToShort (long v, byte startField, byte endField)  { throw new RuntimeException(); }
  public  byte dayTimeIntervalToByte (long v, byte startField, byte endField)  { throw new RuntimeException(); }
}
