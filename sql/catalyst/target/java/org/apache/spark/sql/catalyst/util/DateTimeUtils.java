...
public  class DateTimeUtils {
  ...
  static public  java.time.LocalDateTime microsToLocalDateTime (long micros)  { throw new RuntimeException(); }
  static public  long localDateTimeToMicros (java.time.LocalDateTime localDateTime)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  int anyToDays (Object obj)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  long anyToMicros (Object obj)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  scala.Tuple3<int[], scala.Option<java.time.ZoneId>, java.lang.Object> parseTimestampString (org.apache.spark.unsafe.types.UTF8String s)  { throw new RuntimeException(); }
  /**
  ...
  static public  long stringToTimestampAnsi (org.apache.spark.unsafe.types.UTF8String s, java.time.ZoneId timeZoneId, java.lang.String errorContext)  { throw new RuntimeException(); }
  static public  long doubleToTimestampAnsi (double d, java.lang.String errorContext)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  scala.Option<java.lang.Object> stringToTimestampWithoutTimeZone (org.apache.spark.unsafe.types.UTF8String s, boolean allowTimeZone)  { throw new RuntimeException(); }
  /**
   * Trims and parses a given UTF8 string to a corresponding {@link Long} value which representing the
   ...
   * @return (undocumented)
   */
  static public  scala.Option<java.lang.Object> stringToTimestampWithoutTimeZone (org.apache.spark.unsafe.types.UTF8String s)  { throw new RuntimeException(); }
  static public  long stringToTimestampWithoutTimeZoneAnsi (org.apache.spark.unsafe.types.UTF8String s, java.lang.String errorContext)  { throw new RuntimeException(); }
  /**
  ...
  static public  int stringToDateAnsi (org.apache.spark.unsafe.types.UTF8String s, java.lang.String errorContext)  { throw new RuntimeException(); }
  /**
   ...
   * @param zoneId (undocumented)
   */
  static public  long timestampNTZAddInterval (long start, int months, int days, long microseconds, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  long convertTimestampNtzToAnotherTz (java.lang.String sourceTz, java.lang.String targetTz, long micros)  { throw new RuntimeException(); }
  /**
   ...
   *         successfully otherwise None.
   */
  static public  scala.Option<java.lang.Object> convertSpecialTimestampNTZ (java.lang.String input, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  long subtractTimestamps (long endMicros, long startMicros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return A timestamp value, expressed in microseconds since 1970-01-01 00:00:00Z.
   */
  static public  long timestampAdd (java.lang.String unit, int quantity, long micros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  long timestampDiff (java.lang.String unit, long startTs, long endTs, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
}
