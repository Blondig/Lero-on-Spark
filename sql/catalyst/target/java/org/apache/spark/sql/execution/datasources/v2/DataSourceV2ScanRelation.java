 ...
 */
public  class DataSourceV2ScanRelation extends org.apache.spark.sql.catalyst.plans.logical.LogicalPlan implements org.apache.spark.sql.catalyst.plans.logical.LeafNode, org.apache.spark.sql.catalyst.analysis.NamedRelation, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   DataSourceV2ScanRelation (org.apache.spark.sql.execution.datasources.v2.DataSourceV2Relation relation, org.apache.spark.sql.connector.read.Scan scan, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.AttributeReference> output, scala.Option<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>> keyGroupedPartitioning)  { throw new RuntimeException(); }
