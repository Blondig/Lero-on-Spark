...
public  class RewriteCorrelatedScalarSubquery {
  /**
   * Statically evaluate an {@link Aggregate} on an empty input and return a mapping
   * between its output attribute expression ID and evaluated result.
   * @param a (undocumented)
   * @return (undocumented)
   */
  static public  scala.collection.immutable.Map<org.apache.spark.sql.catalyst.expressions.ExprId, org.apache.spark.sql.catalyst.expressions.Expression> evalAggregateOnZeroTups (org.apache.spark.sql.catalyst.plans.logical.Aggregate a)  { throw new RuntimeException(); }
