...
public  class RegExpReplace extends org.apache.spark.sql.catalyst.expressions.QuaternaryExpression implements org.apache.spark.sql.catalyst.expressions.ImplicitCastInputTypes, org.apache.spark.sql.catalyst.expressions.NullIntolerant, scala.Product, scala.Serializable {
  ...
  protected  org.apache.spark.sql.catalyst.expressions.RegExpReplace withNewChildrenInternal (org.apache.spark.sql.catalyst.expressions.Expression first, org.apache.spark.sql.catalyst.expressions.Expression second, org.apache.spark.sql.catalyst.expressions.Expression third, org.apache.spark.sql.catalyst.expressions.Expression fourth)  { throw new RuntimeException(); }
}
