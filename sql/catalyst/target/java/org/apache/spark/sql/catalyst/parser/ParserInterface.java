...
public  interface ParserInterface {
  ...
  /**
   * Parse a query string to a {@link LogicalPlan}.
   * @param sqlText (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan parseQuery (java.lang.String sqlText) throws org.apache.spark.sql.catalyst.parser.ParseException ;
  /**
