...
public  class IntervalStringStyles {
  static public  scala.Enumeration.Value ANSI_STYLE ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value HIVE_STYLE ()  { throw new RuntimeException(); }
