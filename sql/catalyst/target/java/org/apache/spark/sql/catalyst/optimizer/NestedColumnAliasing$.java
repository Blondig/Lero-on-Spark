...
public  class NestedColumnAliasing$ {
   ...
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> rewritePlanIfSubsetFieldsUsed (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> exprList, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> exclusiveAttrs)  { throw new RuntimeException(); }
  /**
