...
public  interface TernaryLike<T extends org.apache.spark.sql.catalyst.trees.TreeNode<T>> {
  ...
  public  T withNewChildrenInternal (T newFirst, T newSecond, T newThird)  ;
}
