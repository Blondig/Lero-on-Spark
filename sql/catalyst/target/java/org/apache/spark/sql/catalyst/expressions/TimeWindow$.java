...
public  class TimeWindow$ implements scala.Serializable {
   ...
   *         precision.
   */
  public  long getIntervalInMicroSeconds (java.lang.String interval)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long parseExpression (org.apache.spark.sql.catalyst.expressions.Expression expr)  { throw new RuntimeException(); }
