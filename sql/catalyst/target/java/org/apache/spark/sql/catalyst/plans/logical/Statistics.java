...
public  class Statistics implements scala.Product, scala.Serializable {
  ...
  public  boolean isRuntime ()  { throw new RuntimeException(); }
  public   Statistics (scala.math.BigInt sizeInBytes, scala.Option<scala.math.BigInt> rowCount, org.apache.spark.sql.catalyst.expressions.AttributeMap<org.apache.spark.sql.catalyst.plans.logical.ColumnStat> attributeStats, boolean isRuntime)  { throw new RuntimeException(); }
