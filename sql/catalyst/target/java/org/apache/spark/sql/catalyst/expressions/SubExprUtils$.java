...
public  class SubExprUtils$ implements org.apache.spark.sql.catalyst.expressions.PredicateHelper {
   ...
   * @return (undocumented)
   */
  public <E extends org.apache.spark.sql.catalyst.expressions.Expression> E stripOuterReference (E e)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <E extends org.apache.spark.sql.catalyst.expressions.Expression> scala.collection.Seq<E> stripOuterReferences (scala.collection.Seq<E> e)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <E extends org.apache.spark.sql.catalyst.expressions.Expression> E wrapOuterReference (E e)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> getOuterReferences (org.apache.spark.sql.catalyst.expressions.Expression expr)  { throw new RuntimeException(); }
  /**
