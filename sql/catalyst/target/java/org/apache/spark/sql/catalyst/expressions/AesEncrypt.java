 ...
 */
public  class AesEncrypt extends org.apache.spark.sql.catalyst.expressions.Expression implements org.apache.spark.sql.catalyst.expressions.RuntimeReplaceable, org.apache.spark.sql.catalyst.expressions.ImplicitCastInputTypes, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   AesEncrypt (org.apache.spark.sql.catalyst.expressions.Expression input, org.apache.spark.sql.catalyst.expressions.Expression key, org.apache.spark.sql.catalyst.expressions.Expression mode, org.apache.spark.sql.catalyst.expressions.Expression padding)  { throw new RuntimeException(); }
  // not preceding
  public  org.apache.spark.sql.catalyst.expressions.Expression replacement ()  { throw new RuntimeException(); }
  public   AesEncrypt (org.apache.spark.sql.catalyst.expressions.Expression input, org.apache.spark.sql.catalyst.expressions.Expression key, org.apache.spark.sql.catalyst.expressions.Expression mode)  { throw new RuntimeException(); }
  public   AesEncrypt (org.apache.spark.sql.catalyst.expressions.Expression input, org.apache.spark.sql.catalyst.expressions.Expression key)  { throw new RuntimeException(); }
