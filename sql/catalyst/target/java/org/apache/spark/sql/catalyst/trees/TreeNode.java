...
public abstract class TreeNode<BaseType extends org.apache.spark.sql.catalyst.trees.TreeNode<BaseType>> implements scala.Product, org.apache.spark.sql.catalyst.trees.TreePatternBits {
  // not preceding
  ...
  /**
   * Test whether there is {@link TreeNode} satisfies the conditions specified in <code>f</code>.
   * The condition is recursively applied to this node and all of its children (pre-order).
   * @param f (undocumented)
   * @return (undocumented)
   */
  public  boolean exists (scala.Function1<BaseType, java.lang.Object> f)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Default tree pattern {@link BitSet] for a {@link TreeNode}.
   * @return (undocumented)
   */
  protected  org.apache.spark.util.collection.BitSet getDefaultTreePatternBits ()  { throw new RuntimeException(); }
   ...
   * @return true if the rule has been marked as ineffective; false otherwise. If <code>ruleId</code> is
   *         UnknownId, it returns false.
   */
  protected  boolean isRuleIneffective (org.apache.spark.sql.catalyst.rules.RuleId ruleId)  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.List<scala.Tuple2<java.lang.String, org.json4s.JsonAST.JValue>> jsonFieldsWithStatsAppend ()  { throw new RuntimeException(); }
  public  java.lang.String jsonWithStats ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  protected final  BaseType legacyWithNewChildren (scala.collection.Seq<BaseType> newChildren)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Mark that a rule (with id <code>ruleId</code>) is ineffective for this TreeNode and its subtree.
   * <p>
   * @param ruleId the unique identifier of the rule. If <code>ruleId</code> is UnknownId, it is a no-op.
   */
  protected  void markRuleAsIneffective (org.apache.spark.sql.catalyst.rules.RuleId ruleId)  { throw new RuntimeException(); }
  /**
   ...
   */
  protected  scala.collection.Seq<scala.Enumeration.Value> nodePatterns ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  BaseType transformDownWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<BaseType, BaseType> rule)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  BaseType transformUpWithBeforeAndAfterRuleOnChildren (scala.Function1<BaseType, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<scala.Tuple2<BaseType, BaseType>, BaseType> rule)  { throw new RuntimeException(); }
  /**
   * Returns a copy of this node where <code>rule</code> has been recursively applied first to all of its
   * children and then itself (post-order). When <code>rule</code> does not apply to a given node, it is left
   * unchanged.
   ...
   * @return (undocumented)
   */
  public  BaseType transformUpWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<BaseType, BaseType> rule)  { throw new RuntimeException(); }
  /**
   * Returns a copy of this node where <code>rule</code> has been recursively applied to the tree.
   * When <code>rule</code> does not apply to a given node it is left unchanged.
   * Users should not expect a specific directionality. If a specific directionality is needed,
   ...
   * @return (undocumented)
   */
  public  BaseType transformWithPruning (scala.Function1<org.apache.spark.sql.catalyst.trees.TreePatternBits, java.lang.Object> cond, org.apache.spark.sql.catalyst.rules.RuleId ruleId, scala.PartialFunction<BaseType, BaseType> rule)  { throw new RuntimeException(); }
  // not preceding
  ...
  public final  BaseType withNewChildren (scala.collection.Seq<BaseType> newChildren)  { throw new RuntimeException(); }
  protected abstract  BaseType withNewChildrenInternal (scala.collection.IndexedSeq<BaseType> newChildren)  ;
}
