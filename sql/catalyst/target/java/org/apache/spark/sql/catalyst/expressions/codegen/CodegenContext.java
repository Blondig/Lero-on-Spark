...
public  class CodegenContext implements org.apache.spark.internal.Logging {
  ...
  /**
   * Evaluates a sequence of <code>SubExprEliminationState</code> which represent subexpressions. After
   * evaluating a subexpression, this method will clean up the code block to avoid duplicate
   * evaluation.
   * @param subExprStates (undocumented)
   * @return (undocumented)
   */
  public  java.lang.String evaluateSubExprEliminationState (scala.collection.Iterable<org.apache.spark.sql.catalyst.expressions.codegen.SubExprEliminationState> subExprStates)  { throw new RuntimeException(); }
  /**
  ...
  public  java.lang.String splitExpressionsWithCurrentInputs (scala.collection.Seq<java.lang.String> expressions, java.lang.String funcName, scala.collection.Seq<scala.Tuple2<java.lang.String, java.lang.String>> extraArguments, java.lang.String returnType, scala.Function1<java.lang.String, java.lang.String> makeSplitFunction, scala.Function1<scala.collection.Seq<java.lang.String>, java.lang.String> foldFunctions)  { throw new RuntimeException(); }
    scala.collection.immutable.Map<org.apache.spark.sql.catalyst.expressions.ExpressionEquals, org.apache.spark.sql.catalyst.expressions.codegen.SubExprEliminationState> subExprEliminationExprs ()  { throw new RuntimeException(); }
  /**
   ...
   * <p>
   * The generated code snippet for subexpression is wrapped in <code>SubExprEliminationState</code>, which
   * contains an <code>ExprCode</code> and the children <code>SubExprEliminationState</code> if any. The <code>ExprCode</code>
   * includes java source code, result variable name and is-null variable name of the subexpression.
   * <p>
   * Besides, this also returns a sequences of <code>ExprCode</code> which are expression codes that need to
   * be evaluated (as their input parameters) before evaluating subexpressions.
   * <p>
   * To evaluate the returned subexpressions, please call <code>evaluateSubExprEliminationState</code> with
   * the <code>SubExprEliminationState</code>s to be evaluated. During generating the code, it will cleanup
   * the states to avoid duplicate evaluation.
   * <p>
   * The details of subexpression generation:
   *   1. Gets subexpression set. See <code>EquivalentExpressions</code>.
   ...
   *   1. Wrapping in <code>withSubExprEliminationExprs</code> call with current subexpression map. Each
   ...
   *      (subexpression -> <code>SubExprEliminationState</code>) into the map. So in next subexpression
