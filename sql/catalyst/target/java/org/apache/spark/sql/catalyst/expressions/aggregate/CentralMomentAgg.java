 ...
 */
public abstract class CentralMomentAgg extends org.apache.spark.sql.catalyst.expressions.aggregate.DeclarativeAggregate implements org.apache.spark.sql.catalyst.expressions.ImplicitCastInputTypes, org.apache.spark.sql.catalyst.trees.UnaryLike<org.apache.spark.sql.catalyst.expressions.Expression> {
  public   CentralMomentAgg (org.apache.spark.sql.catalyst.expressions.Expression child, boolean nullOnDivideByZero)  { throw new RuntimeException(); }
