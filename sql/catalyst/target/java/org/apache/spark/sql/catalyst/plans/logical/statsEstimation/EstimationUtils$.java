...
public  class EstimationUtils$ {
   ...
   * @return (undocumented)
   */
  public  scala.Option<scala.math.BigInt> updateStat (scala.math.BigInt oldNumRows, scala.math.BigInt newNumRows, scala.Option<scala.math.BigInt> oldStatOpt, scala.Option<scala.math.BigInt> updatedStatOpt)  { throw new RuntimeException(); }
