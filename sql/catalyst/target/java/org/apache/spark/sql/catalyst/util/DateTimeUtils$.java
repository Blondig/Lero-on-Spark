...
public  class DateTimeUtils$ {
   ...
   * @return (undocumented)
   */
  public  int microsToDays (long micros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long daysToMicros (int days, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  public  java.time.LocalDateTime microsToLocalDateTime (long micros)  { throw new RuntimeException(); }
  public  long localDateTimeToMicros (java.time.LocalDateTime localDateTime)  { throw new RuntimeException(); }
  /**
   ...
   * <p>
   * @param obj Either an object of <code>java.sql.Date</code> or <code>java.time.LocalDate</code>.
   * @return The number of days since 1970-01-01.
   */
  public  int anyToDays (Object obj)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  java.sql.Date toJavaDate (int days)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  java.sql.Timestamp toJavaTimestamp (long micros)  { throw new RuntimeException(); }
  /**
   ...
   * <p>
   * @param obj Either an object of <code>java.sql.Timestamp</code> or <code>java.time.Instant</code>.
   * @return The number of micros since the epoch.
   */
  public  long anyToMicros (Object obj)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long fromJulianDay (int days, long nanos)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Tuple2<java.lang.Object, java.lang.Object> toJulianDay (long micros)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long microsToMillis (long micros)  { throw new RuntimeException(); }
  /**
   * Converts milliseconds since the epoch to microseconds.
   * @param millis (undocumented)
   * @return (undocumented)
   */
  public  long millisToMicros (long millis)  { throw new RuntimeException(); }
  public  org.apache.spark.unsafe.types.UTF8String cleanLegacyTimestampStr (org.apache.spark.unsafe.types.UTF8String s)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  scala.Tuple3<int[], scala.Option<java.time.ZoneId>, java.lang.Object> parseTimestampString (org.apache.spark.unsafe.types.UTF8String s)  { throw new RuntimeException(); }
  /**
   * Trims and parses a given UTF8 timestamp string to the corresponding a corresponding {@link Long}
   * value. The return type is {@link Option} in order to distinguish between 0L and null. Please
   * refer to <code>parseTimestampString</code> for the allowed formats
   * @param s (undocumented)
  ...
  public  long stringToTimestampAnsi (org.apache.spark.unsafe.types.UTF8String s, java.time.ZoneId timeZoneId, java.lang.String errorContext)  { throw new RuntimeException(); }
  public  long doubleToTimestampAnsi (double d, java.lang.String errorContext)  { throw new RuntimeException(); }
  /**
   * Trims and parses a given UTF8 string to a corresponding {@link Long} value which representing the
   ...
   * <code>None</code> if <code>allowTimeZone</code> is set to <code>false</code>. If <code>allowTimeZone</code> is set to <code>true</code>, the method
   ...
   * <p>
   * The return type is {@link Option} in order to distinguish between 0L and null. Please
   * refer to <code>parseTimestampString</code> for the allowed formats.
   * @param s (undocumented)
   * @param allowTimeZone (undocumented)
   * @return (undocumented)
   */
  public  scala.Option<java.lang.Object> stringToTimestampWithoutTimeZone (org.apache.spark.unsafe.types.UTF8String s, boolean allowTimeZone)  { throw new RuntimeException(); }
  /**
   * Trims and parses a given UTF8 string to a corresponding {@link Long} value which representing the
   ...
   * @return (undocumented)
   */
  public  scala.Option<java.lang.Object> stringToTimestampWithoutTimeZone (org.apache.spark.unsafe.types.UTF8String s)  { throw new RuntimeException(); }
  public  long stringToTimestampWithoutTimeZoneAnsi (org.apache.spark.unsafe.types.UTF8String s, java.lang.String errorContext)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.time.Instant microsToInstant (long micros)  { throw new RuntimeException(); }
  /**
  ...
  public  int stringToDateAnsi (org.apache.spark.unsafe.types.UTF8String s, java.lang.String errorContext)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getHours (long micros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getMinutes (long micros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getSeconds (long micros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.types.Decimal getSecondsWithFraction (long micros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getMicroseconds (long micros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   * Returns the 'day in year' value for the given number of days since 1970-01-01.
   * @param days (undocumented)
   * @return (undocumented)
   */
  public  int getDayInYear (int days)  { throw new RuntimeException(); }
  /**
   * Returns the year value for the given number of days since 1970-01-01.
   * @param days (undocumented)
   * @return (undocumented)
   */
  public  int getYear (int days)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getWeekBasedYear (int days)  { throw new RuntimeException(); }
  /** Returns the quarter for the given number of days since 1970-01-01. */
  public  int getQuarter (int days)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getMonth (int days)  { throw new RuntimeException(); }
  /**
   * Returns the 'day of month' value for the given number of days since 1970-01-01.
   * @param days (undocumented)
   * @return (undocumented)
   */
  public  int getDayOfMonth (int days)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getDayOfWeek (int days)  { throw new RuntimeException(); }
  /**
   * Returns the day of the week for the given number of days since 1970-01-01
   ...
   * @return (undocumented)
   */
  public  int getWeekDay (int days)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getWeekOfYear (int days)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  long timestampAddMonths (long micros, int months, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return A timestamp value, expressed in microseconds since 1970-01-01 00:00:00Z.
   */
  public  long timestampAddDayTime (long micros, long dayTime, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @param zoneId (undocumented)
   */
  public  long timestampNTZAddInterval (long start, int months, int days, long microseconds, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  double monthsBetween (long micros1, long micros2, boolean roundOff, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getNextDateForDayOfWeek (int startDay, int dayOfWeek)  { throw new RuntimeException(); }
  /** Returns last day of the month for the given number of days since 1970-01-01. */
  public  int getLastDayOfMonth (int days)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  int truncDate (int days, int level)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long truncTimestamp (long micros, int level, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long convertTz (long micros, java.time.ZoneId fromZone, java.time.ZoneId toZone)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  long convertTimestampNtzToAnotherTz (java.lang.String sourceTz, java.lang.String targetTz, long micros)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long fromUTCTime (long micros, java.lang.String timeZone)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long toUTCTime (long micros, java.lang.String timeZone)  { throw new RuntimeException(); }
  /**
   ...
   *         successfully otherwise None.
   */
  public  scala.Option<java.lang.Object> convertSpecialTimestampNTZ (java.lang.String input, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.unsafe.types.CalendarInterval subtractDates (int endDay, int startDay)  { throw new RuntimeException(); }
  /**
   ...
   *         instants <code>end</code> and <code>start</code>.
   */
  public  long subtractTimestamps (long endMicros, long startMicros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @param quantity The amount of <code>unit</code>s to add. It can be positive or negative.
   * @param micros The input timestamp value, expressed in microseconds since 1970-01-01 00:00:00Z.
   * @param zoneId The time zone ID at which the operation is performed.
   * @return A timestamp value, expressed in microseconds since 1970-01-01 00:00:00Z.
   */
  public  long timestampAdd (java.lang.String unit, int quantity, long micros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   * Gets the difference between two timestamps.
   * <p>
   * @param unit Specifies the interval units in which to express the difference between
   *             the two timestamp parameters.
   * @param startTs A timestamp which the function subtracts from <code>endTs</code>.
   * @param endTs A timestamp from which the function subtracts <code>startTs</code>.
   * @param zoneId The time zone ID at which the operation is performed.
   * @return The time span between two timestamp values, in the units specified.
   */
  public  long timestampDiff (java.lang.String unit, long startTs, long endTs, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
}
