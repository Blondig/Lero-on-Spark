...
public abstract class RuleExecutor<TreeType extends org.apache.spark.sql.catalyst.trees.TreeNode<?>> implements org.apache.spark.internal.Logging {
   ...
   * @param previousPlan (undocumented)
   * @param currentPlan (undocumented)
   * @return (undocumented)
   */
  protected  boolean isPlanIntegral (TreeType previousPlan, TreeType currentPlan)  { throw new RuntimeException(); }
  /**
