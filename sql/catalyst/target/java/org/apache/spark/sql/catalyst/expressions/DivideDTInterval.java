...
public  class DivideDTInterval extends org.apache.spark.sql.catalyst.expressions.BinaryExpression implements org.apache.spark.sql.catalyst.expressions.ImplicitCastInputTypes, org.apache.spark.sql.catalyst.expressions.IntervalDivide, org.apache.spark.sql.catalyst.expressions.NullIntolerant, scala.Serializable, scala.Product {
  ...
  // not preceding
  public   DivideDTInterval (org.apache.spark.sql.catalyst.expressions.Expression interval, org.apache.spark.sql.catalyst.expressions.Expression num)  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.catalyst.expressions.DivideDTInterval withNewChildrenInternal (org.apache.spark.sql.catalyst.expressions.Expression newLeft, org.apache.spark.sql.catalyst.expressions.Expression newRight)  { throw new RuntimeException(); }
}
