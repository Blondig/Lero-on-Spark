...
public  class GlobalTempViewManager {
   ...
   */
  public  void create (java.lang.String name, org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation viewDefinition, boolean overrideIfExists)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation> get (java.lang.String name)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean update (java.lang.String name, org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation viewDefinition)  { throw new RuntimeException(); }
}
