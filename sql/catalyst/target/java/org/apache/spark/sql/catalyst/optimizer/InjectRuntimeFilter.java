 ...
 * else in the future.
 */
public  class InjectRuntimeFilter {
  static public  boolean hasRuntimeFilter (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan left, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan right, org.apache.spark.sql.catalyst.expressions.Expression leftKey, org.apache.spark.sql.catalyst.expressions.Expression rightKey)  { throw new RuntimeException(); }
  static public  boolean hasDynamicPruningSubquery (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan left, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan right, org.apache.spark.sql.catalyst.expressions.Expression leftKey, org.apache.spark.sql.catalyst.expressions.Expression rightKey)  { throw new RuntimeException(); }
  static public  boolean hasBloomFilter (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan left, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan right, org.apache.spark.sql.catalyst.expressions.Expression leftKey, org.apache.spark.sql.catalyst.expressions.Expression rightKey)  { throw new RuntimeException(); }
  static public  boolean hasInSubquery (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan left, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan right, org.apache.spark.sql.catalyst.expressions.Expression leftKey, org.apache.spark.sql.catalyst.expressions.Expression rightKey)  { throw new RuntimeException(); }
