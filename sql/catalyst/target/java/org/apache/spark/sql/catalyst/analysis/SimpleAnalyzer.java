...
/**
 * A trivial {@link Analyzer} with a dummy {@link SessionCatalog}, {@link EmptyFunctionRegistry} and
 * {@link EmptyTableFunctionRegistry}. Used for testing when all relations are already filled
...
public  class SimpleAnalyzer {
  ...
  static   java.lang.String extraHintForAnsiTypeCoercionExpression (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan)  { throw new RuntimeException(); }
  ...
  static protected  boolean isPlanIntegral (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan previousPlan, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan currentPlan)  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.trees.TreeNodeTag<java.lang.Object> DATA_TYPE_MISMATCH_ERROR ()  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.trees.TreeNodeTag<java.lang.String> DATA_TYPE_MISMATCH_ERROR_MESSAGE ()  { throw new RuntimeException(); }
  ...
  static protected  void org$apache$spark$sql$catalyst$analysis$CheckAnalysis$_setter_$DATA_TYPE_MISMATCH_ERROR_$eq (org.apache.spark.sql.catalyst.trees.TreeNodeTag<java.lang.Object> x$1)  { throw new RuntimeException(); }
  static protected  void org$apache$spark$sql$catalyst$analysis$CheckAnalysis$_setter_$DATA_TYPE_MISMATCH_ERROR_MESSAGE_$eq (org.apache.spark.sql.catalyst.trees.TreeNodeTag<java.lang.String> x$1)  { throw new RuntimeException(); }
