...
public  class QueryParsingErrors {
  ...
  static public  java.lang.Throwable transformNotSupportQuantifierError (org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  ...
  static public  java.lang.Throwable lateralJoinWithNaturalJoinUnsupportedError (org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable lateralJoinWithUsingJoinUnsupportedError (org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable unsupportedLateralJoinTypeError (org.antlr.v4.runtime.ParserRuleContext ctx, java.lang.String joinType)  { throw new RuntimeException(); }
  static public  java.lang.Throwable invalidLateralJoinRelationError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.RelationPrimaryContext ctx)  { throw new RuntimeException(); }
  ...
  static public  java.lang.Throwable fromToIntervalUnsupportedError (java.lang.String from, java.lang.String to, org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable mixedIntervalUnitsError (java.lang.String literal, org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  ...
  static public  java.lang.Throwable charTypeMissingLengthError (java.lang.String dataType, org.apache.spark.sql.catalyst.parser.SqlBaseParser.PrimitiveDataTypeContext ctx)  { throw new RuntimeException(); }
  ...
  static public  java.lang.Throwable showFunctionsInvalidPatternError (java.lang.String pattern, org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  ...
  static public  java.lang.Throwable unexpectedFomatForSetConfigurationError (org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable invalidPropertyKeyForSetQuotedConfigurationError (java.lang.String keyCandidate, java.lang.String valueStr, org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable invalidPropertyValueForSetQuotedConfigurationError (java.lang.String valueCandidate, java.lang.String keyStr, org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable unexpectedFormatForResetConfigurationError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.ResetConfigurationContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable intervalValueOutOfRangeError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.IntervalContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable invalidTimeZoneDisplacementValueError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.SetTimeZoneContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable createTempTableNotSpecifyProviderError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateTableContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable rowFormatNotUsedWithStoredAsError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateTableLikeContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable useDefinedRecordReaderOrWriterClassesError (org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable directoryPathAndOptionsPathBothSpecifiedError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.InsertOverwriteDirContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable unsupportedLocalFileSchemeError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.InsertOverwriteDirContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable invalidGroupingSetError (java.lang.String element, org.apache.spark.sql.catalyst.parser.SqlBaseParser.GroupingAnalyticsContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable createViewWithBothIfNotExistsAndReplaceError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateViewContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable defineTempViewWithIfNotExistsError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateViewContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable notAllowedToAddDBPrefixForTempViewError (java.lang.String database, org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateViewContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable createFuncWithBothIfNotExistsAndReplaceError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateFunctionContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable defineTempFuncWithIfNotExistsError (org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateFunctionContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable unsupportedFunctionNameError (java.lang.String quoted, org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateFunctionContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable specifyingDBInCreateTempFuncError (java.lang.String databaseName, org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateFunctionContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable invalidTableValuedFunctionNameError (scala.collection.Seq<java.lang.String> name, org.apache.spark.sql.catalyst.parser.SqlBaseParser.TableValuedFunctionContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable unclosedBracketedCommentError (java.lang.String command, org.apache.spark.sql.catalyst.trees.Origin position)  { throw new RuntimeException(); }
  static public  java.lang.Throwable invalidTimeTravelSpec (java.lang.String reason, org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  static public  java.lang.Throwable invalidNameForDropTempFunc (scala.collection.Seq<java.lang.String> name, org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
