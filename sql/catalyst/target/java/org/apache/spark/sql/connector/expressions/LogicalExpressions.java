...
public  class LogicalExpressions {
  ...
  static public  org.apache.spark.sql.connector.expressions.SortedBucketTransform bucket (int numBuckets, org.apache.spark.sql.connector.expressions.NamedReference[] references, org.apache.spark.sql.connector.expressions.NamedReference[] sortedCols)  { throw new RuntimeException(); }
