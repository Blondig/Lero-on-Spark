...
public  class RowEncoder {
  static public  org.apache.spark.sql.catalyst.encoders.ExpressionEncoder<org.apache.spark.sql.Row> apply (org.apache.spark.sql.types.StructType schema, boolean lenient)  { throw new RuntimeException(); }
   ...
   * @param lenient (undocumented)
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.types.DataType externalDataTypeForInput (org.apache.spark.sql.types.DataType dt, boolean lenient)  { throw new RuntimeException(); }
