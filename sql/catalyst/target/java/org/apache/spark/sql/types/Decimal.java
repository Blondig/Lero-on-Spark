...
public final class Decimal implements scala.math.Ordered<org.apache.spark.sql.types.Decimal>, scala.Serializable {
  ...
  static public  org.apache.spark.sql.types.Decimal fromStringANSI (org.apache.spark.unsafe.types.UTF8String str, org.apache.spark.sql.types.DecimalType to, java.lang.String errorContext)  { throw new RuntimeException(); }
  /**
   ...
   */
    org.apache.spark.sql.types.Decimal toPrecision (int precision, int scale, scala.Enumeration.Value roundMode, boolean nullOnOverflow, java.lang.String context)  { throw new RuntimeException(); }
  /**
   * Update precision and scale while keeping our value the same, and return true if successful.
   * <p>
   * @return true if successful, false if overflow would occur
