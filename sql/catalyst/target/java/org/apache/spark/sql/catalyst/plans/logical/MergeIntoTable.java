 ...
 */
public  class MergeIntoTable extends org.apache.spark.sql.catalyst.plans.logical.LogicalPlan implements org.apache.spark.sql.catalyst.plans.logical.BinaryCommand, org.apache.spark.sql.catalyst.plans.logical.SupportsSubquery, scala.Product, scala.Serializable {
  ...
  protected  org.apache.spark.sql.catalyst.plans.logical.MergeIntoTable withNewChildrenInternal (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan newLeft, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan newRight)  { throw new RuntimeException(); }
}
