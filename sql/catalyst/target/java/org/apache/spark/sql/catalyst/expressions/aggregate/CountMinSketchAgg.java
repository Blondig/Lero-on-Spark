 ...
 */
public  class CountMinSketchAgg extends org.apache.spark.sql.catalyst.expressions.aggregate.TypedImperativeAggregate<org.apache.spark.util.sketch.CountMinSketch> implements org.apache.spark.sql.catalyst.expressions.ExpectsInputTypes, org.apache.spark.sql.catalyst.trees.QuaternaryLike<org.apache.spark.sql.catalyst.expressions.Expression>, scala.Product, scala.Serializable {
  ...
  protected  org.apache.spark.sql.catalyst.expressions.aggregate.CountMinSketchAgg withNewChildrenInternal (org.apache.spark.sql.catalyst.expressions.Expression first, org.apache.spark.sql.catalyst.expressions.Expression second, org.apache.spark.sql.catalyst.expressions.Expression third, org.apache.spark.sql.catalyst.expressions.Expression fourth)  { throw new RuntimeException(); }
}
