...
public  class Utils$ {
   ...
   */
  public  double[] unpackUpperTriangular (int n, double[] triangularValues)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int indexUpperTriangular (int n, int i, int j)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  double log1pExp (double x)  { throw new RuntimeException(); }
  /**
   * Perform in-place softmax conversion.
   * @param array (undocumented)
   */
  public  void softmax (double[] array)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  void softmax (double[] input, int n, int offset, int step, double[] output)  { throw new RuntimeException(); }
}
