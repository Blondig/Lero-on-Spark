...
public  class BLAS$ implements scala.Serializable {
  ...
  public   BLAS$ ()  { throw new RuntimeException(); }
    dev.ludovic.netlib.BLAS javaBLAS ()  { throw new RuntimeException(); }
    dev.ludovic.netlib.BLAS nativeBLAS ()  { throw new RuntimeException(); }
    dev.ludovic.netlib.BLAS getBLAS (int vectorSize)  { throw new RuntimeException(); }
  /**
   * y += a * x
   ...
   * @param y (undocumented)
   */
  public  void gemv (double alpha, org.apache.spark.ml.linalg.Matrix A, double[] x, double beta, double[] y)  { throw new RuntimeException(); }
  /**
   * y := alpha * A * x + beta * y
