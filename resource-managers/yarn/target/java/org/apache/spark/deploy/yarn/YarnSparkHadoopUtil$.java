...
public  class YarnSparkHadoopUtil$ {
  ...
  public  double AM_MEMORY_OVERHEAD_FACTOR ()  { throw new RuntimeException(); }
   ...
   */
  public  java.lang.String replaceEnvVars (java.lang.String unresolvedString, scala.collection.immutable.Map<java.lang.String, java.lang.String> env, boolean isWindows)  { throw new RuntimeException(); }
  /**
  ...
  public  org.apache.hadoop.yarn.api.records.ContainerId getContainerId ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long executorOffHeapMemorySizeAsMb (org.apache.spark.SparkConf sparkConf, org.apache.spark.resource.ExecutorResourceRequest execRequest)  { throw new RuntimeException(); }
}
