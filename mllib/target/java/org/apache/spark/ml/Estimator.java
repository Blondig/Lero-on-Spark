...
public abstract class Estimator<M extends org.apache.spark.ml.Model<M>> extends org.apache.spark.ml.PipelineStage {
   ...
   */
  public  scala.collection.Seq<M> fit (org.apache.spark.sql.Dataset<?> dataset, scala.collection.Seq<org.apache.spark.ml.param.ParamMap> paramMaps)  { throw new RuntimeException(); }
}
