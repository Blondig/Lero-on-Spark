...
public  class EnsembleModelReadWrite$ {
   ...
   */
  public <M extends org.apache.spark.ml.param.Params> void saveImpl (M instance, java.lang.String path, org.apache.spark.sql.SparkSession sparkSession, org.json4s.JsonAST.JObject extraMetadata)  { throw new RuntimeException(); }
  /**
   ...
   * @param sparkSession (undocumented)
   */
  public  scala.Tuple3<org.apache.spark.ml.util.DefaultParamsReader.Metadata, scala.Tuple2<org.apache.spark.ml.util.DefaultParamsReader.Metadata, org.apache.spark.ml.tree.Node>[], double[]> loadImpl (java.lang.String path, org.apache.spark.sql.SparkSession sparkSession, java.lang.String className, java.lang.String treeClassName)  { throw new RuntimeException(); }
}
