...
public  class GaussianMixtureModel$ implements org.apache.spark.ml.util.MLReadable<org.apache.spark.ml.clustering.GaussianMixtureModel>, scala.Serializable {
   ...
   */
    double[] computeProbabilities (org.apache.spark.ml.linalg.Vector features, org.apache.spark.ml.stat.distribution.MultivariateGaussian[] dists, double[] weights)  { throw new RuntimeException(); }
}
