...
public  class MLUtils {
  ...
  /**
   * Version of <code>kFold()</code> taking a fold column name.
   * @param df (undocumented)
   * @param numFolds (undocumented)
   * @param foldColName (undocumented)
   * @return (undocumented)
   */
  static public  scala.Tuple2<org.apache.spark.rdd.RDD<org.apache.spark.sql.Row>, org.apache.spark.rdd.RDD<org.apache.spark.sql.Row>>[] kFold (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df, int numFolds, java.lang.String foldColName)  { throw new RuntimeException(); }
  /**
